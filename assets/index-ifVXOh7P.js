...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function xo(e,t,n){let r=new Float32Array(oo),i=new V(0,1,0);return new Vi({name:`SphericalGaussianBlur`,defines:{n:oo,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:wo(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function So(){return new Vi({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:wo(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Co(){return new Vi({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:wo(),fragmentShader:`
	...
	`}var To=class extends Yt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new vi(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`)}var Xs={1:`Linear`,2:`Reinhard`,3:`Cineon`,4:`ACESFilmic`,6:`AgX`,7:`Neutral`,5:`Custom`};function Zs(e,t){let n=Xs[t];return n===void 0?(L(`WebGLProgram: Unsupported toneMapping:`,t),`vec3 `+e+`( vec3 color ) { return LinearToneMapping( color ); }`):`vec3 `+e+`( vec3 color ) { return `+n+`ToneMapping( color ); }`}var Qs=new V;function $s(){return It.getLuminanceCoefficients(Qs),[`float luminance( const in vec3 rgb ) {`,`	const vec3 weights = vec3( ${Qs.x.toFixed(4)}, ${Qs.y.toFixed(4)}, ${Qs.z.toFixed(4)} );`,`	return dot( weights, rgb );`,`}`].join(`
...
`)+`
`+_);let y=v+g+o,b=v+_+s,x=Hs(i,i.VERTEX_SHADER,y),S=Hs(i,i.FRAGMENT_SHADER,b);i.attachShader(h,x),i.attachShader(h,S),n.index0AttributeName===void 0?n.hasPositionAttribute===!0&&i.bindAttribLocation(h,0,`position`):i.bindAttribLocation(h,0,n.index0AttributeName),i.linkProgram(h);function C(t){if(e.debug.checkShaderErrors){let n=i.getProgramInfoLog(h)||``,r=i.getShaderInfoLog(x)||``,a=i.getShaderInfoLog(S)||``,o=n.trim(),s=r.trim(),c=a.trim(),l=!0,u=!0;if(i.getProgramParameter(h,i.LINK_STATUS)===!1)if(l=!1,typeof e.debug.onShaderError==`function`)e.debug.onShaderError(i,h,x,S);else{let e=Js(i,x,`vertex`),n=Js(i,S,`fragment`);R(`WebGLProgram: Shader Error `+i.getError()+` - VALIDATE_STATUS `+i.getProgramParameter(h,i.VALIDATE_STATUS)+`
...
}`,el=class{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(e,t){if(this.texture===null){let n=new Si(e.texture);(e.depthNear!==t.depthNear||e.depthFar!==t.depthFar)&&(this.depthNear=e.depthNear,this.depthFar=e.depthFar),this.texture=n}}getMesh(e){if(this.texture!==null&&this.mesh===null){let t=e.cameras[0].viewport,n=new Vi({vertexShader:Qc,fragmentShader:$c,uniforms:{depthColor:{value:this.texture},depthWidth:{value:t.z},depthHeight:{value:t.w}}});this.mesh=new Zr(new Ai(20,20),n)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}},tl=class extends nt{constructor(e,t){super();let n=this,r=null,i=1,a=null,o=`local-floor`,s=1,c=null,u=null,d=null,f=null,p=null,h=null,g=typeof XRWebGLBinding<`u`,_=new el,v={},b=t.getContextAttributes(),x=null,S=null,C=[],D=[],ee=new B,te=null,O=new ba;O.viewport=new qt;let ne=new ba;ne.viewport=new qt;let k=[O,ne],A=new Oa,re=null,ie=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(e){let t=C[e];return t===void 0&&(t=new On,C[e]=t),t.getTargetRaySpace()},this.getControllerGrip=function(e){let t=C[e];return t===void 0&&(t=new On,C[e]=t),t.getGripSpace()},this.getHand=function(e){let t=C[e];return t===void 0&&(t=new On,C[e]=t),t.getHandSpace()};function j(e){let t=D.indexOf(e.inputSource);if(t===-1)return;let n=C[t];n!==void 0&&(n.update(e.inputSource,e.frame,c||a),n.dispatchEvent({type:e.type,data:e.inputSource}))}function ae(){r.removeEventListener(`select`,j),r.removeEventListener(`selectstart`,j),r.removeEventListener(`selectend`,j),r.removeEventListener(`squeeze`,j),r.removeEventListener(`squeezestart`,j),r.removeEventListener(`squeezeend`,j),r.removeEventListener(`end`,ae),r.removeEventListener(`inputsourceschange`,oe);for(let e=0;e<C.length;e++){let t=D[e];t!==null&&(D[e]=null,C[e].disconnect(t))}re=null,ie=null,_.reset();for(let e in v)delete v[e];e.setRenderTarget(x),p=null,f=null,d=null,r=null,S=null,pe.stop(),n.isPresenting=!1,e.setPixelRatio(te),e.setSize(ee.width,ee.height,!1),n.dispatchEvent({type:`sessionend`})}this.setFramebufferScaleFactor=function(e){i=e,n.isPresenting===!0&&L(`WebXRManager: Cannot change framebuffer scale while presenting.`)},this.setReferenceSpaceType=function(e){o=e,n.isPresenting===!0&&L(`WebXRManager: Cannot change reference space type while presenting.`)},this.getReferenceSpace=function(){return c||a},this.setReferenceSpace=function(e){c=e},this.getBaseLayer=function(){return f===null?p:f},this.getBinding=function(){return d===null&&g&&(d=new XRWebGLBinding(r,t)),d},this.getFrame=function(){return h},this.getSession=function(){return r},this.setSession=async function(u){if(r=u,r!==null){if(x=e.getRenderTarget(),r.addEventListener(`select`,j),r.addEventListener(`selectstart`,j),r.addEventListener(`selectend`,j),r.addEventListener(`squeeze`,j),r.addEventListener(`squeezestart`,j),r.addEventListener(`squeezeend`,j),r.addEventListener(`end`,ae),r.addEventListener(`inputsourceschange`,oe),b.xrCompatible!==!0&&await t.makeXRCompatible(),te=e.getPixelRatio(),e.getSize(ee),g&&`createProjectionLayer`in XRWebGLBinding.prototype){let n=null,a=null,o=null;b.depth&&(o=b.stencil?t.DEPTH24_STENCIL8:t.DEPTH_COMPONENT24,n=b.stencil?E:T,a=b.stencil?y:m);let s={colorFormat:t.RGBA8,depthFormat:o,scaleFactor:i};d=this.getBinding(),f=d.createProjectionLayer(s),r.updateRenderState({layers:[f]}),e.setPixelRatio(1),e.setSize(f.textureWidth,f.textureHeight,!1),S=new Yt(f.textureWidth,f.textureHeight,{format:w,type:l,depthTexture:new bi(f.textureWidth,f.textureHeight,a,void 0,void 0,void 0,void 0,void 0,void 0,n),stencilBuffer:b.stencil,colorSpace:e.outputColorSpace,samples:b.antialias?4:0,resolveDepthBuffer:f.ignoreDepthValues===!1,resolveStencilBuffer:f.ignoreDepthValues===!1})}else{let n={antialias:b.antialias,alpha:!0,depth:b.depth,stencil:b.stencil,framebufferScaleFactor:i};p=new XRWebGLLayer(r,t,n),r.updateRenderState({baseLayer:p}),e.setPixelRatio(1),e.setSize(p.framebufferWidth,p.framebufferHeight,!1),S=new Yt(p.framebufferWidth,p.framebufferHeight,{format:w,type:l,colorSpace:e.outputColorSpace,stencilBuffer:b.stencil,resolveDepthBuffer:p.ignoreDepthValues===!1,resolveStencilBuffer:p.ignoreDepthValues===!1})}S.isXRRenderTarget=!0,this.setFoveation(s),c=null,a=await r.requestReferenceSpace(o),pe.setContext(r),pe.start(),n.isPresenting=!0,n.dispatchEvent({type:`sessionstart`})}},this.getEnvironmentBlendMode=function(){if(r!==null)return r.environmentBlendMode},this.getDepthTexture=function(){return _.getDepthTexture()};function oe(e){for(let t=0;t<e.removed.length;t++){let n=e.removed[t],r=D.indexOf(n);r>=0&&(D[r]=null,C[r].disconnect(n))}for(let t=0;t<e.added.length;t++){let n=e.added[t],r=D.indexOf(n);if(r===-1){for(let e=0;e<C.length;e++)if(e>=D.length){D.push(n),r=e;break}else if(D[e]===null){D[e]=n,r=e;break}if(r===-1)break}let i=C[r];i&&i.connect(n)}}let se=new V,ce=new V;function le(e,t,n){se.setFromMatrixPosition(t.matrixWorld),ce.setFromMatrixPosition(n.matrixWorld);let r=se.distanceTo(ce),i=t.projectionMatrix.elements,a=n.projectionMatrix.elements,o=i[14]/(i[10]-1),s=i[14]/(i[10]+1),c=(i[9]+1)/i[5],l=(i[9]-1)/i[5],u=(i[8]-1)/i[0],d=(a[8]+1)/a[0],f=o*u,p=o*d,m=r/(-u+d),h=m*-u;if(t.matrixWorld.decompose(e.position,e.quaternion,e.scale),e.translateX(h),e.translateZ(m),e.matrixWorld.compose(e.position,e.quaternion,e.scale),e.matrixWorldInverse.copy(e.matrixWorld).invert(),i[10]===-1)e.projectionMatrix.copy(t.projectionMatrix),e.projectionMatrixInverse.copy(t.projectionMatrixInverse);else{let t=o+m,n=s+m,i=f-h,a=p+(r-h),u=c*s/n*t,d=l*s/n*t;e.projectionMatrix.makePerspective(i,a,u,d,t,n),e.projectionMatrixInverse.copy(e.projectionMatrix).invert()}}function ue(e,t){t===null?e.matrixWorld.copy(e.matrix):e.matrixWorld.multiplyMatrices(t.matrixWorld,e.matrix),e.matrixWorldInverse.copy(e.matrixWorld).invert()}this.updateCamera=function(e){if(r===null)return;let t=e.near,n=e.far;_.texture!==null&&(_.depthNear>0&&(t=_.depthNear),_.depthFar>0&&(n=_.depthFar)),A.near=ne.near=O.near=t,A.far=ne.far=O.far=n,(re!==A.near||ie!==A.far)&&(r.updateRenderState({depthNear:A.near,depthFar:A.far}),re=A.near,ie=A.far),A.layers.mask=e.layers.mask|6,O.layers.mask=A.layers.mask&-5,ne.layers.mask=A.layers.mask&-3;let i=e.parent,a=A.cameras;ue(A,i);for(let e=0;e<a.length;e++)ue(a[e],i);a.length===2?le(A,O,ne):A.projectionMatrix.copy(O.projectionMatrix),de(e,A,i)};function de(e,t,n){n===null?e.matrix.copy(t.matrixWorld):(e.matrix.copy(n.matrixWorld),e.matrix.invert(),e.matrix.multiply(t.matrixWorld)),e.matrix.decompose(e.position,e.quaternion,e.scale),e.updateMatrixWorld(!0),e.projectionMatrix.copy(t.projectionMatrix),e.projectionMatrixInverse.copy(t.projectionMatrixInverse),e.isPerspectiveCamera&&(e.fov=ot*2*Math.atan(1/e.projectionMatrix.elements[5]),e.zoom=1)}this.getCamera=function(){return A},this.getFoveation=function(){if(!(f===null&&p===null))return s},this.setFoveation=function(e){s=e,f!==null&&(f.fixedFoveation=e),p!==null&&p.fixedFoveation!==void 0&&(p.fixedFoveation=e)},this.hasDepthSensing=function(){return _.texture!==null},this.getDepthSensingMesh=function(){return _.getMesh(A)},this.getCameraTexture=function(e){return v[e]};let M=null;function fe(t,i){if(u=i.getViewerPose(c||a),h=i,u!==null){let t=u.views;p!==null&&(e.setRenderTargetFramebuffer(S,p.framebuffer),e.setRenderTarget(S));let i=!1;t.length!==A.cameras.length&&(A.cameras.length=0,i=!0);for(let n=0;n<t.length;n++){let r=t[n],a=null;if(p!==null)a=p.getViewport(r);else{let t=d.getViewSubImage(f,r);a=t.viewport,n===0&&(e.setRenderTargetTextures(S,t.colorTexture,t.depthStencilTexture),e.setRenderTarget(S))}let o=k[n];o===void 0&&(o=new ba,o.layers.enable(n),o.viewport=new qt,k[n]=o),o.matrix.fromArray(r.transform.matrix),o.matrix.decompose(o.position,o.quaternion,o.scale),o.projectionMatrix.fromArray(r.projectionMatrix),o.projectionMatrixInverse.copy(o.projectionMatrix).invert(),o.viewport.set(a.x,a.y,a.width,a.height),n===0&&(A.matrix.copy(o.matrix),A.matrix.decompose(A.position,A.quaternion,A.scale)),i===!0&&A.cameras.push(o)}let a=r.enabledFeatures;if(a&&a.includes(`depth-sensing`)&&r.depthUsage==`gpu-optimized`&&g){d=n.getBinding();let e=d.getDepthInformation(t[0]);e&&e.isValid&&e.texture&&_.init(e,r.renderState)}if(a&&a.includes(`camera-access`)&&g){e.state.unbindTexture(),d=n.getBinding();for(let e=0;e<t.length;e++){let n=t[e].camera;if(n){let e=v[n];e||(e=new Si,v[n]=e);let t=d.getCameraImage(n);e.sourceTexture=t}}}}for(let e=0;e<C.length;e++){let t=D[e],n=C[e];t!==null&&n!==void 0&&n.update(t,i,c||a)}M&&M(t,i),i.detectedPlanes&&n.dispatchEvent({type:`planesdetected`,data:i}),h=null}let pe=new qa;pe.setAnimationLoop(fe),this.setAnimationLoop=function(e){M=e},this.dispose=function(){}}},nl=new Qt,rl=new H;rl.set(-1,0,0,0,1,0,0,0,1);function il(e,t){function n(e,t){e.matrixAutoUpdate===!0&&e.updateMatrix(),t.value.copy(e.matrix)}function r(t,n){n.color.getRGB(t.fogColor.value,Li(e)),n.isFog?(t.fogNear.value=n.near,t.fogFar.value=n.far):n.isFogExp2&&(t.fogDensity.value=n.density)}function i(e,t,n,r,i){t.isNodeMaterial?t.uniformsNeedUpdate=!1:t.isMeshBasicMaterial?a(e,t):t.isMeshLambertMaterial?(a(e,t),t.envMap&&(e.envMapIntensity.value=t.envMapIntensity)):t.isMeshToonMaterial?(a(e,t),d(e,t)):t.isMeshPhongMaterial?(a(e,t),u(e,t),t.envMap&&(e.envMapIntensity.value=t.envMapIntensity)):t.isMeshStandardMaterial?(a(e,t),f(e,t),t.isMeshPhysicalMaterial&&p(e,t,i)):t.isMeshMatcapMaterial?(a(e,t),m(e,t)):t.isMeshDepthMaterial?a(e,t):t.isMeshDistanceMaterial?(a(e,t),h(e,t)):t.isMeshNormalMaterial?a(e,t):t.isLineBasicMaterial?(o(e,t),t.isLineDashedMaterial&&s(e,t)):t.isPointsMaterial?c(e,t,n,r):t.isSpriteMaterial?l(e,t):t.isShadowMaterial?(e.color.value.copy(t.color),e.opacity.value=t.opacity):t.isShaderMaterial&&(t.uniformsNeedUpdate=!1)}function a(e,r){e.opacity.value=r.opacity,r.color&&e.diffuse.value.copy(r.color),r.emissive&&e.emissive.value.copy(r.emissive).multiplyScalar(r.emissiveIntensity),r.map&&(e.map.value=r.map,n(r.map,e.mapTransform)),r.alphaMap&&(e.alphaMap.value=r.alphaMap,n(r.alphaMap,e.alphaMapTransform)),r.bumpMap&&(e.bumpMap.value=r.bumpMap,n(r.bumpMap,e.bumpMapTransform),e.bumpScale.value=r.bumpScale,r.side===1&&(e.bumpScale.value*=-1)),r.normalMap&&(e.normalMap.value=r.normalMap,n(r.normalMap,e.normalMapTransform),e.normalScale.value.copy(r.normalScale),r.side===1&&e.normalScale.value.negate()),r.displacementMap&&(e.displacementMap.value=r.displacementMap,n(r.displacementMap,e.displacementMapTransform),e.displacementScale.value=r.displacementScale,e.displacementBias.value=r.displacementBias),r.emissiveMap&&(e.emissiveMap.value=r.emissiveMap,n(r.emissiveMap,e.emissiveMapTransform)),r.specularMap&&(e.specularMap.value=r.specularMap,n(r.specularMap,e.specularMapTransform)),r.alphaTest>0&&(e.alphaTest.value=r.alphaTest);let i=t.get(r),a=i.envMap,o=i.envMapRotation;a&&(e.envMap.value=a,e.envMapRotation.value.setFromMatrix4(nl.makeRotationFromEuler(o)).transpose(),a.isCubeTexture&&a.isRenderTargetTexture===!1&&e.envMapRotation.value.premultiply(rl),e.reflectivity.value=r.reflectivity,e.ior.value=r.ior,e.refractionRatio.value=r.refractionRatio),r.lightMap&&(e.lightMap.value=r.lightMap,e.lightMapIntensity.value=r.lightMapIntensity,n(r.lightMap,e.lightMapTransform)),r.aoMap&&(e.aoMap.value=r.aoMap,e.aoMapIntensity.value=r.aoMapIntensity,n(r.aoMap,e.aoMapTransform))}function o(e,t){e.diffuse.value.copy(t.color),e.opacity.value=t.opacity,t.map&&(e.map.value=t.map,n(t.map,e.mapTransform))}function s(e,t){e.dashSize.value=t.dashSize,e.totalSize.value=t.dashSize+t.gapSize,e.scale.value=t.scale}function c(e,t,r,i){e.diffuse.value.copy(t.color),e.opacity.value=t.opacity,e.size.value=t.size*r,e.scale.value=i*.5,t.map&&(e.map.value=t.map,n(t.map,e.uvTransform)),t.alphaMap&&(e.alphaMap.value=t.alphaMap,n(t.alphaMap,e.alphaMapTransform)),t.alphaTest>0&&(e.alphaTest.value=t.alphaTest)}function l(e,t){e.diffuse.value.copy(t.color),e.opacity.value=t.opacity,e.rotation.value=t.rotation,t.map&&(e.map.value=t.map,n(t.map,e.mapTransform)),t.alphaMap&&(e.alphaMap.value=t.alphaMap,n(t.alphaMap,e.alphaMapTransform)),t.alphaTest>0&&(e.alphaTest.value=t.alphaTest)}function u(e,t){e.specular.value.copy(t.specular),e.shininess.value=Math.max(t.shininess,1e-4)}function d(e,t){t.gradientMap&&(e.gradientMap.value=t.gradientMap)}function f(e,t){e.metalness.value=t.metalness,t.metalnessMap&&(e.metalnessMap.value=t.metalnessMap,n(t.metalnessMap,e.metalnessMapTransform)),e.roughness.value=t.roughness,t.roughnessMap&&(e.roughnessMap.value=t.roughnessMap,n(t.roughnessMap,e.roughnessMapTransform)),t.envMap&&(e.envMapIntensity.value=t.envMapIntensity)}function p(e,t,r){e.ior.value=t.ior,t.sheen>0&&(e.sheenColor.value.copy(t.sheenColor).multiplyScalar(t.sheen),e.sheenRoughness.value=t.sheenRoughness,t.sheenColorMap&&(e.sheenColorMap.value=t.sheenColorMap,n(t.sheenColorMap,e.sheenColorMapTransform)),t.sheenRoughnessMap&&(e.sheenRoughnessMap.value=t.sheenRoughnessMap,n(t.sheenRoughnessMap,e.sheenRoughnessMapTransform))),t.clearcoat>0&&(e.clearcoat.value=t.clearcoat,e.clearcoatRoughness.value=t.clearcoatRoughness,t.clearcoatMap&&(e.clearcoatMap.value=t.clearcoatMap,n(t.clearcoatMap,e.clearcoatMapTransform)),t.clearcoatRoughnessMap&&(e.clearcoatRoughnessMap.value=t.clearcoatRoughnessMap,n(t.clearcoatRoughnessMap,e.clearcoatRoughnessMapTransform)),t.clearcoatNormalMap&&(e.clearcoatNormalMap.value=t.clearcoatNormalMap,n(t.clearcoatNormalMap,e.clearcoatNormalMapTransform),e.clearcoatNormalScale.value.copy(t.clearcoatNormalScale),t.side===1&&e.clearcoatNormalScale.value.negate())),t.dispersion>0&&(e.dispersion.value=t.dispersion),t.iridescence>0&&(e.iridescence.value=t.iridescence,e.iridescenceIOR.value=t.iridescenceIOR,e.iridescenceThicknessMinimum.value=t.iridescenceThicknessRange[0],e.iridescenceThicknessMaximum.value=t.iridescenceThicknessRange[1],t.iridescenceMap&&(e.iridescenceMap.value=t.iridescenceMap,n(t.iridescenceMap,e.iridescenceMapTransform)),t.iridescenceThicknessMap&&(e.iridescenceThicknessMap.value=t.iridescenceThicknessMap,n(t.iridescenceThicknessMap,e.iridescenceThicknessMapTransform))),t.transmission>0&&(e.transmission.value=t.transmission,e.transmissionSamplerMap.value=r.texture,e.transmissionSamplerSize.value.set(r.width,r.height),t.transmissionMap&&(e.transmissionMap.value=t.transmissionMap,n(t.transmissionMap,e.transmissionMapTransform)),e.thickness.value=t.thickness,t.thicknessMap&&(e.thicknessMap.value=t.thicknessMap,n(t.thicknessMap,e.thicknessMapTransform)),e.attenuationDistance.value=t.attenuationDistance,e.attenuationColor.value.copy(t.attenuationColor)),t.anisotropy>0&&(e.anisotropyVector.value.set(t.anisotropy*Math.cos(t.anisotropyRotation),t.anisotropy*Math.sin(t.anisotropyRotation)),t.anisotropyMap&&(e.anisotropyMap.value=t.anisotropyMap,n(t.anisotropyMap,e.anisotropyMapTransform))),e.specularIntensity.value=t.specularIntensity,e.specularColor.value.copy(t.specularColor),t.specularColorMap&&(e.specularColorMap.value=t.specularColorMap,n(t.specularColorMap,e.specularColorMapTransform)),t.specularIntensityMap&&(e.specularIntensityMap.value=t.specularIntensityMap,n(t.specularIntensityMap,e.specularIntensityMapTransform))}function m(e,t){t.matcap&&(e.matcap.value=t.matcap)}function h(e,n){let r=t.get(n).light;e.referencePosition.value.setFromMatrixPosition(r.matrixWorld),e.nearDistance.value=r.shadow.camera.near,e.farDistance.value=r.shadow.camera.far}return{refreshFogUniforms:r,refreshMaterialUniforms:i}}function al(e,t,n,r){let i={},a={},o=[],s=e.getParameter(e.MAX_UNIFORM_BUFFER_BINDINGS);function c(e,t){let n=t.program;r.uniformBlockBinding(e,n)}function l(e,n){let o=i[e.id];o===void 0&&(g(e),o=u(e),i[e.id]=o,e.addEventListener(`dispose`,v));let s=n.program;r.updateUBOMapping(e,s);let c=t.render.frame;a[e.id]!==c&&(f(e),a[e.id]=c)}function u(t){let n=d();t.__bindingPointIndex=n;let r=e.createBuffer(),i=t.__size,a=t.usage;return e.bindBuffer(e.UNIFORM_BUFFER,r),e.bufferData(e.UNIFORM_BUFFER,i,a),e.bindBuffer(e.UNIFORM_BUFFER,null),e.bindBufferBase(e.UNIFORM_BUFFER,n,r),r}function d(){for(let e=0;e<s;e++)if(o.indexOf(e)===-1)return o.push(e),e;return R(`WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached.`),0}function f(t){let n=i[t.id],r=t.uniforms,a=t.__cache;e.bindBuffer(e.UNIFORM_BUFFER,n);for(let e=0,t=r.length;e<t;e++){let t=r[e];if(Array.isArray(t))for(let n=0,r=t.length;n<r;n++)p(t[n],e,n,a);else p(t,e,0,a)}e.bindBuffer(e.UNIFORM_BUFFER,null)}function p(t,n,r,i){if(h(t,n,r,i)===!0){let n=t.__offset,r=t.value;if(Array.isArray(r)){let e=0;for(let n=0;n<r.length;n++){let i=r[n],a=_(i);m(i,t.__data,e),typeof i!=`number`&&typeof i!=`boolean`&&!i.isMatrix3&&!ArrayBuffer.isView(i)&&(e+=a.storage/Float32Array.BYTES_PER_ELEMENT)}}else m(r,t.__data,0);e.bufferSubData(e.UNIFORM_BUFFER,n,t.__data)}}function m(e,t,n){typeof e==`number`||typeof e==`boolean`?t[0]=e:e.isMatrix3?(t[0]=e.elements[0],t[1]=e.elements[1],t[2]=e.elements[2],t[3]=0,t[4]=e.elements[3],t[5]=e.elements[4],t[6]=e.elements[5],t[7]=0,t[8]=e.elements[6],t[9]=e.elements[7],t[10]=e.elements[8],t[11]=0):ArrayBuffer.isView(e)?t.set(new e.constructor(e.buffer,e.byteOffset,t.length)):e.toArray(t,n)}function h(e,t,n,r){let i=e.value,a=t+`_`+n;if(r[a]===void 0)return typeof i==`number`||typeof i==`boolean`?r[a]=i:ArrayBuffer.isView(i)?r[a]=i.slice():r[a]=i.clone(),!0;{let e=r[a];if(typeof i==`number`||typeof i==`boolean`){if(e!==i)return r[a]=i,!0}else if(ArrayBuffer.isView(i))return!0;else if(e.equals(i)===!1)return e.copy(i),!0}return!1}function g(e){let t=e.uniforms,n=0;for(let e=0,r=t.length;e<r;e++){let r=Array.isArray(t[e])?t[e]:[t[e]];for(let e=0,t=r.length;e<t;e++){let t=r[e],i=Array.isArray(t.value)?t.value:[t.value];for(let e=0,r=i.length;e<r;e++){let r=i[e],a=_(r),o=n%16,s=o%a.boundary,c=o+s;n+=s,c!==0&&16-c<a.storage&&(n+=16-c),t.__data=new Float32Array(a.storage/Float32Array.BYTES_PER_ELEMENT),t.__offset=n,n+=a.storage}}}let r=n%16;return r>0&&(n+=16-r),e.__size=n,e.__cache={},this}function _(e){let t={boundary:0,storage:0};return typeof e==`number`||typeof e==`boolean`?(t.boundary=4,t.storage=4):e.isVector2?(t.boundary=8,t.storage=8):e.isVector3||e.isColor?(t.boundary=16,t.storage=12):e.isVector4?(t.boundary=16,t.storage=16):e.isMatrix3?(t.boundary=48,t.storage=48):e.isMatrix4?(t.boundary=64,t.storage=64):e.isTexture?L(`WebGLRenderer: Texture samplers can not be part of an uniforms group.`):ArrayBuffer.isView(e)?(t.boundary=16,t.storage=e.byteLength):L(`WebGLRenderer: Unsupported uniform value type.`,e),t}function v(t){let n=t.target;n.removeEventListener(`dispose`,v);let r=o.indexOf(n.__bindingPointIndex);o.splice(r,1),e.deleteBuffer(i[n.id]),delete i[n.id],delete a[n.id]}function y(){for(let t in i)e.deleteBuffer(i[t]);o=[],i={},a={}}return{bind:c,update:l,dispose:y}}var ol=new Uint16Array([12469,15057,12620,14925,13266,14620,13807,14376,14323,13990,14545,13625,14713,13328,14840,12882,14931,12528,14996,12233,15039,11829,15066,11525,15080,11295,15085,10976,15082,10705,15073,10495,13880,14564,13898,14542,13977,14430,14158,14124,14393,13732,14556,13410,14702,12996,14814,12596,14891,12291,14937,11834,14957,11489,14958,11194,14943,10803,14921,10506,14893,10278,14858,9960,14484,14039,14487,14025,14499,13941,14524,13740,14574,13468,14654,13106,14743,12678,14818,12344,14867,11893,14889,11509,14893,11180,14881,10751,14852,10428,14812,10128,14765,9754,14712,9466,14764,13480,14764,13475,14766,13440,14766,13347,14769,13070,14786,12713,14816,12387,14844,11957,14860,11549,14868,11215,14855,10751,14825,10403,14782,10044,14729,9651,14666,9352,14599,9029,14967,12835,14966,12831,14963,12804,14954,12723,14936,12564,14917,12347,14900,11958,14886,11569,14878,11247,14859,10765,14828,10401,14784,10011,14727,9600,14660,9289,14586,8893,14508,8533,15111,12234,15110,12234,15104,12216,15092,12156,15067,12010,15028,11776,14981,11500,14942,11205,14902,10752,14861,10393,14812,9991,14752,9570,14682,9252,14603,8808,14519,8445,14431,8145,15209,11449,15208,11451,15202,11451,15190,11438,15163,11384,15117,11274,15055,10979,14994,10648,14932,10343,14871,9936,14803,9532,14729,9218,14645,8742,14556,8381,14461,8020,14365,7603,15273,10603,15272,10607,15267,10619,15256,10631,15231,10614,15182,10535,15118,10389,15042,10167,14963,9787,14883,9447,14800,9115,14710,8665,14615,8318,14514,7911,14411,7507,14279,7198,15314,9675,15313,9683,15309,9712,15298,9759,15277,9797,15229,9773,15166,9668,15084,9487,14995,9274,14898,8910,14800,8539,14697,8234,14590,7790,14479,7409,14367,7067,14178,6621,15337,8619,15337,8631,15333,8677,15325,8769,15305,8871,15264,8940,15202,8909,15119,8775,15022,8565,14916,8328,14804,8009,14688,7614,14569,7287,14448,6888,14321,6483,14088,6171,15350,7402,15350,7419,15347,7480,15340,7613,15322,7804,15287,7973,15229,8057,15148,8012,15046,7846,14933,7611,14810,7357,14682,7069,14552,6656,14421,6316,14251,5948,14007,5528,15356,5942,15356,5977,15353,6119,15348,6294,15332,6551,15302,6824,15249,7044,15171,7122,15070,7050,14949,6861,14818,6611,14679,6349,14538,6067,14398,5651,14189,5311,13935,4958,15359,4123,15359,4153,15356,4296,15353,4646,15338,5160,15311,5508,15263,5829,15188,6042,15088,6094,14966,6001,14826,5796,14678,5543,14527,5287,14377,4985,14133,4586,13869,4257,15360,1563,15360,1642,15358,2076,15354,2636,15341,3350,15317,4019,15273,4429,15203,4732,15105,4911,14981,4932,14836,4818,14679,4621,14517,4386,14359,4156,14083,3795,13808,3437,15360,122,15360,137,15358,285,15355,636,15344,1274,15322,2177,15281,2765,15215,3223,15120,3451,14995,3569,14846,3567,14681,3466,14511,3305,14344,3121,14037,2800,13753,2467,15360,0,15360,1,15359,21,15355,89,15346,253,15325,479,15287,796,15225,1148,15133,1492,15008,1749,14856,1882,14685,1886,14506,1783,14324,1608,13996,1398,13702,1183]),sl=null;function cl(){return sl===null&&(sl=new ei(ol,16,16,te,g),sl.name=`DFG_LUT`,sl.minFilter=o,sl.magFilter=o,sl.wrapS=t,sl.wrapT=t,sl.generateMipmaps=!1,sl.needsUpdate=!0),sl}var ll=class{constructor(e={}){let{canvas:t=Ye(),context:n=null,depth:r=!0,stencil:i=!1,alpha:a=!1,antialias:o=!1,premultipliedAlpha:s=!0,preserveDrawingBuffer:u=!1,powerPreference:d=`default`,failIfMajorPerformanceCaveat:p=!1,reversedDepthBuffer:h=!1,outputBufferType:b=l}=e;this.isWebGLRenderer=!0;let x;if(n!==null){if(typeof WebGLRenderingContext<`u`&&n instanceof WebGLRenderingContext)throw Error(`THREE.WebGLRenderer: WebGL 1 is not supported since r163.`);x=n.getContextAttributes().alpha}else x=a;let S=b,C=new Set([ne,O,ee]),w=new Set([l,m,f,y,_,v]),T=new Uint32Array(4),E=new Int32Array(4),D=new V,te=null,k=null,A=[],re=[],ie=null;this.domElement=t,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=0,this.toneMappingExposure=1,this.transmissionResolutionScale=1;let j=this,ae=!1,oe=null,se=null,ce=null,le=null;this._outputColorSpace=Be;let ue=0,de=0,M=null,fe=-1,pe=null,me=new qt,he=new qt,ge=null,_e=new W(0),ve=0,ye=t.width,be=t.height,xe=1,Se=null,Ce=null,we=new qt(0,0,ye,be),Te=new qt(0,0,ye,be),Ee=!1,De=new _i,Oe=!1,ke=!1,Ae=new Qt,je=new V,Me=new qt,Ne={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0},Pe=!1;function Fe(){return M===null?xe:1}let N=n;function Ie(e,n){return t.getContext(e,n)}try{let e={alpha:!0,depth:r,stencil:i,antialias:o,premultipliedAlpha:s,preserveDrawingBuffer:u,powerPreference:d,failIfMajorPerformanceCaveat:p};if(`setAttribute`in t&&t.setAttribute(`data-engine`,`three.js r185`),t.addEventListener(`webglcontextlost`,lt,!1),t.addEventListener(`webglcontextrestored`,ut,!1),t.addEventListener(`webglcontextcreationerror`,dt,!1),N===null){let t=`webgl2`;if(N=Ie(t,e),N===null)throw Ie(t)?Error(`THREE.WebGLRenderer: Error creating WebGL context with your selected attributes.`):Error(`THREE.WebGLRenderer: Error creating WebGL context.`)}}catch(e){throw R(`WebGLRenderer: `+e.message),e}let Le,Re,P,ze,F,I,Ve,He,Ue,We,Ke,qe,Je,Xe,Qe,$e,tt,nt,rt,it,at,ot,st;function z(){Le=new Do(N),Le.init(),at=new Zc(N,Le),Re=new no(N,Le,e,at),P=new Yc(N,Le),Re.reversedDepthBuffer&&h&&P.buffers.depth.setReversed(!0),se=N.createFramebuffer(),ce=N.createFramebuffer(),le=N.createFramebuffer(),ze=new Ao(N),F=new kc,I=new Xc(N,Le,P,F,Re,at,ze),Ve=new Eo(j),He=new Ja(N),ot=new eo(N,He),Ue=new Oo(N,He,ze,ot),We=new Mo(N,Ue,He,ot,ze),nt=new jo(N,Re,I),Qe=new ro(F),Ke=new Oc(j,Ve,Le,Re,ot,Qe),qe=new il(j,F),Je=new Nc,Xe=new Bc(Le),tt=new $a(j,Ve,P,We,x,s),$e=new Jc(j,We,Re),st=new al(N,ze,Re,P),rt=new to(N,Le,ze),it=new ko(N,Le,ze),ze.programs=Ke.programs,j.capabilities=Re,j.extensions=Le,j.properties=F,j.renderLists=Je,j.shadowMap=$e,j.state=P,j.info=ze}z(),S!==1009&&(ie=new Po(S,t.width,t.height,o,r,i));let ct=new tl(j,N);this.xr=ct,this.getContext=function(){return N},this.getContextAttributes=function(){return N.getContextAttributes()},this.forceContextLoss=function(){let e=Le.get(`WEBGL_lose_context`);e&&e.loseContext()},this.forceContextRestore=function(){let e=Le.get(`WEBGL_lose_context`);e&&e.restoreContext()},this.getPixelRatio=function(){return xe},this.setPixelRatio=function(e){e!==void 0&&(xe=e,this.setSize(ye,be,!1))},this.getSize=function(e){return e.set(ye,be)},this.setSize=function(e,n,r=!0){if(ct.isPresenting){L(`WebGLRenderer: Can't change size while VR device is presenting.`);return}ye=e,be=n,t.width=Math.floor(e*xe),t.height=Math.floor(n*xe),r===!0&&(t.style.width=e+`px`,t.style.height=n+`px`),ie!==null&&ie.setSize(t.width,t.height),this.setViewport(0,0,e,n)},this.getDrawingBufferSize=function(e){return e.set(ye*xe,be*xe).floor()},this.setDrawingBufferSize=function(e,n,r){ye=e,be=n,xe=r,t.width=Math.floor(e*r),t.height=Math.floor(n*r),this.setViewport(0,0,e,n)},this.setEffects=function(e){if(S===1009){R(`WebGLRenderer: setEffects() requires outputBufferType set to HalfFloatType or FloatType.`);return}if(e){for(let t=0;t<e.length;t++)if(e[t].isOutputPass===!0){L(`WebGLRenderer: OutputPass is not needed in setEffects(). Tone mapping and color space conversion are applied automatically.`);break}}ie.setEffects(e||[])},this.getCurrentViewport=function(e){return e.copy(me)},this.getViewport=function(e){return e.copy(we)},this.setViewport=function(e,t,n,r){e.isVector4?we.set(e.x,e.y,e.z,e.w):we.set(e,t,n,r),P.viewport(me.copy(we).multiplyScalar(xe).round())},this.getScissor=function(e){return e.copy(Te)},this.setScissor=function(e,t,n,r){e.isVector4?Te.set(e.x,e.y,e.z,e.w):Te.set(e,t,n,r),P.scissor(he.copy(Te).multiplyScalar(xe).round())},this.getScissorTest=function(){return Ee},this.setScissorTest=function(e){P.setScissorTest(Ee=e)},this.setOpaqueSort=function(e){Se=e},this.setTransparentSort=function(e){Ce=e},this.getClearColor=function(e){return e.copy(tt.getClearColor())},this.setClearColor=function(){tt.setClearColor(...arguments)},this.getClearAlpha=function(){return tt.getClearAlpha()},this.setClearAlpha=function(){tt.setClearAlpha(...arguments)},this.clear=function(e=!0,t=!0,n=!0){let r=0;if(e){let e=!1;if(M!==null){let t=M.texture.format;e=C.has(t)}if(e){let e=M.texture.type,t=w.has(e),n=tt.getClearColor(),r=tt.getClearAlpha(),i=n.r,a=n.g,o=n.b;t?(T[0]=i,T[1]=a,T[2]=o,T[3]=r,N.clearBufferuiv(N.COLOR,0,T)):(E[0]=i,E[1]=a,E[2]=o,E[3]=r,N.clearBufferiv(N.COLOR,0,E))}else r|=N.COLOR_BUFFER_BIT}t&&(r|=N.DEPTH_BUFFER_BIT,this.state.buffers.depth.setMask(!0)),n&&(r|=N.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),r!==0&&N.clear(r)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.setNodesHandler=function(e){e.setRenderer(this),oe=e},this.dispose=function(){t.removeEventListener(`webglcontextlost`,lt,!1),t.removeEventListener(`webglcontextrestored`,ut,!1),t.removeEventListener(`webglcontextcreationerror`,dt,!1),tt.dispose(),Je.dispose(),Xe.dispose(),F.dispose(),Ve.dispose(),We.dispose(),ot.dispose(),st.dispose(),Ke.dispose(),ct.dispose(),ct.removeEventListener(`sessionstart`,vt),ct.removeEventListener(`sessionend`,yt),bt.stop()};function lt(e){e.preventDefault(),Ze(`WebGLRenderer: Context Lost.`),ae=!0}function ut(){Ze(`WebGLRenderer: Context Restored.`),ae=!1;let e=ze.autoReset,t=$e.enabled,n=$e.autoUpdate,r=$e.needsUpdate,i=$e.type;z(),ze.autoReset=e,$e.enabled=t,$e.autoUpdate=n,$e.needsUpdate=r,$e.type=i}function dt(e){R(`WebGLRenderer: A WebGL context could not be created. Reason: `,e.statusMessage)}function ft(e){let t=e.target;t.removeEventListener(`dispose`,ft),pt(t)}function pt(e){mt(e),F.remove(e)}function mt(e){let t=F.get(e).programs;t!==void 0&&(t.forEach(function(e){Ke.releaseProgram(e)}),e.isShaderMaterial&&Ke.releaseShaderCache(e))}this.renderBufferDirect=function(e,t,n,r,i,a){t===null&&(t=Ne);let o=i.isMesh&&i.matrixWorld.determinantAffine()<0,s=kt(e,t,n,r,i);P.setMaterial(r,o);let c=n.index,l=1;if(r.wireframe===!0){if(c=Ue.getWireframeAttribute(n),c===void 0)return;l=2}let u=n.drawRange,d=n.attributes.position,f=u.start*l,p=(u.start+u.count)*l;a!==null&&(f=Math.max(f,a.start*l),p=Math.min(p,(a.start+a.count)*l)),c===null?d!=null&&(f=Math.max(f,0),p=Math.min(p,d.count)):(f=Math.max(f,0),p=Math.min(p,c.count));let m=p-f;if(m<0||m===1/0)return;ot.setup(i,r,s,n,c);let h,g=rt;if(c!==null&&(h=He.get(c),g=it,g.setIndex(h)),i.isMesh)r.wireframe===!0?(P.setLineWidth(r.wireframeLinewidth*Fe()),g.setMode(N.LINES)):g.setMode(N.TRIANGLES);else if(i.isLine){let e=r.linewidth;e===void 0&&(e=1),P.setLineWidth(e*Fe()),i.isLineSegments?g.setMode(N.LINES):i.isLineLoop?g.setMode(N.LINE_LOOP):g.setMode(N.LINE_STRIP)}else i.isPoints?g.setMode(N.POINTS):i.isSprite&&g.setMode(N.TRIANGLES);if(i.isBatchedMesh)if(Le.get(`WEBGL_multi_draw`))g.renderMultiDraw(i._multiDrawStarts,i._multiDrawCounts,i._multiDrawCount);else{let e=i._multiDrawStarts,t=i._multiDrawCounts,n=i._multiDrawCount,a=c?He.get(c).bytesPerElement:1,o=F.get(r).currentProgram.getUniforms();for(let r=0;r<n;r++)o.setValue(N,`_gl_DrawID`,r),g.render(e[r]/a,t[r])}else if(i.isInstancedMesh)g.renderInstances(f,m,i.count);else if(n.isInstancedBufferGeometry){let e=n._maxInstanceCount===void 0?1/0:n._maxInstanceCount,t=Math.min(n.instanceCount,e);g.renderInstances(f,m,t)}else g.render(f,m)};function ht(e,t,n){e.transparent===!0&&e.side===2&&e.forceSinglePass===!1?(e.side=1,e.needsUpdate=!0,Et(e,t,n),e.side=0,e.needsUpdate=!0,Et(e,t,n),e.side=2):Et(e,t,n)}this.compile=function(e,t,n=null){n===null&&(n=e),k=Xe.get(n),k.init(t),re.push(k),n.traverseVisible(function(e){e.isLight&&e.layers.test(t.layers)&&(k.pushLight(e),e.castShadow&&k.pushShadow(e))}),e!==n&&e.traverseVisible(function(e){e.isLight&&e.layers.test(t.layers)&&(k.pushLight(e),e.castShadow&&k.pushShadow(e))}),k.setupLights();let r=new Set;return e.traverse(function(e){if(!(e.isMesh||e.isPoints||e.isLine||e.isSprite))return;let t=e.material;if(t)if(Array.isArray(t))for(let i=0;i<t.length;i++){let a=t[i];ht(a,n,e),r.add(a)}else ht(t,n,e),r.add(t)}),k=re.pop(),r},this.compileAsync=function(e,t,n=null){let r=this.compile(e,t,n);return new Promise(t=>{function n(){if(r.forEach(function(e){F.get(e).currentProgram.isReady()&&r.delete(e)}),r.size===0){t(e);return}setTimeout(n,10)}Le.get(`KHR_parallel_shader_compile`)===null?setTimeout(n,10):n()})};let gt=null;function _t(e){gt&&gt(e)}function vt(){bt.stop()}function yt(){bt.start()}let bt=new qa;bt.setAnimationLoop(_t),typeof self<`u`&&bt.setContext(self),this.setAnimationLoop=function(e){gt=e,ct.setAnimationLoop(e),e===null?bt.stop():bt.start()},ct.addEventListener(`sessionstart`,vt),ct.addEventListener(`sessionend`,yt),this.render=function(e,t){if(t!==void 0&&t.isCamera!==!0){R(`WebGLRenderer.render: camera is not an instance of THREE.Camera.`);return}if(ae===!0)return;oe!==null&&oe.renderStart(e,t);let n=ct.enabled===!0&&ct.isPresenting===!0,r=ie!==null&&(M===null||n)&&ie.begin(j,M);if(e.matrixWorldAutoUpdate===!0&&e.updateMatrixWorld(),t.parent===null&&t.matrixWorldAutoUpdate===!0&&t.updateMatrixWorld(),ct.enabled===!0&&ct.isPresenting===!0&&(ie===null||ie.isCompositing()===!1)&&(ct.cameraAutoUpdate===!0&&ct.updateCamera(t),t=ct.getCamera()),e.isScene===!0&&e.onBeforeRender(j,e,t,M),k=Xe.get(e,re.length),k.init(t),k.state.textureUnits=I.getTextureUnits(),re.push(k),Ae.multiplyMatrices(t.projectionMatrix,t.matrixWorldInverse),De.setFromProjectionMatrix(Ae,Ge,t.reversedDepth),ke=this.localClippingEnabled,Oe=Qe.init(this.clippingPlanes,ke),te=Je.get(e,A.length),te.init(),A.push(te),ct.enabled===!0&&ct.isPresenting===!0){let e=j.xr.getDepthSensingMesh();e!==null&&xt(e,t,-1/0,j.sortObjects)}xt(e,t,0,j.sortObjects),te.finish(),j.sortObjects===!0&&te.sort(Se,Ce,t.reversedDepth),Pe=ct.enabled===!1||ct.isPresenting===!1||ct.hasDepthSensing()===!1,Pe&&tt.addToRenderList(te,e),this.info.render.frame++,this.info.autoReset===!0&&this.info.reset(),Oe===!0&&Qe.beginShadows();let i=k.state.shadowsArray;if($e.render(i,e,t),Oe===!0&&Qe.endShadows(),(r&&ie.hasRenderPass())===!1){let n=te.opaque,r=te.transmissive;if(k.setupLights(),t.isArrayCamera){let i=t.cameras;if(r.length>0)for(let t=0,a=i.length;t<a;t++){let a=i[t];Ct(n,r,e,a)}Pe&&tt.render(e);for(let t=0,n=i.length;t<n;t++){let n=i[t];St(te,e,n,n.viewport)}}else r.length>0&&Ct(n,r,e,t),Pe&&tt.render(e),St(te,e,t)}M!==null&&de===0&&(I.updateMultisampleRenderTarget(M),I.updateRenderTargetMipmap(M)),r&&ie.end(j),e.isScene===!0&&e.onAfterRender(j,e,t),ot.resetDefaultState(),fe=-1,pe=null,re.pop(),re.length>0?(k=re[re.length-1],I.setTextureUnits(k.state.textureUnits),Oe===!0&&Qe.setGlobalState(j.clippingPlanes,k.state.camera)):k=null,A.pop(),te=A.length>0?A[A.length-1]:null,oe!==null&&oe.renderEnd()};function xt(e,t,n,r){if(e.visible===!1)return;if(e.layers.test(t.layers)){if(e.isGroup)n=e.renderOrder;else if(e.isLOD)e.autoUpdate===!0&&e.update(t);else if(e.isLightProbeGrid)k.pushLightProbeGrid(e);else if(e.isLight)k.pushLight(e),e.castShadow&&k.pushShadow(e);else if(e.isSprite){if(!e.frustumCulled||De.intersectsSprite(e)){r&&Me.setFromMatrixPosition(e.matrixWorld).applyMatrix4(Ae);let t=We.update(e),i=e.material;i.visible&&te.push(e,t,i,n,Me.z,null)}}else if((e.isMesh||e.isLine||e.isPoints)&&(!e.frustumCulled||De.intersectsObject(e))){let t=We.update(e),i=e.material;if(r&&(e.boundingSphere===void 0?(t.boundingSphere===null&&t.computeBoundingSphere(),Me.copy(t.boundingSphere.center)):(e.boundingSphere===null&&e.computeBoundingSphere(),Me.copy(e.boundingSphere.center)),Me.applyMatrix4(e.matrixWorld).applyMatrix4(Ae)),Array.isArray(i)){let r=t.groups;for(let a=0,o=r.length;a<o;a++){let o=r[a],s=i[o.materialIndex];s&&s.visible&&te.push(e,t,s,n,Me.z,o)}}else i.visible&&te.push(e,t,i,n,Me.z,null)}}let i=e.children;for(let e=0,a=i.length;e<a;e++)xt(i[e],t,n,r)}function St(e,t,n,r){let{opaque:i,transmissive:a,transparent:o}=e;k.setupLightsView(n),Oe===!0&&Qe.setGlobalState(j.clippingPlanes,n),r&&P.viewport(me.copy(r)),i.length>0&&wt(i,t,n),a.length>0&&wt(a,t,n),o.length>0&&wt(o,t,n),P.buffers.depth.setTest(!0),P.buffers.depth.setMask(!0),P.buffers.color.setMask(!0),P.setPolygonOffset(!1)}function Ct(e,t,n,r){if((n.isScene===!0?n.overrideMaterial:null)!==null)return;if(k.state.transmissionRenderTarget[r.id]===void 0){let e=Le.has(`EXT_color_buffer_half_float`)||Le.has(`EXT_color_buffer_float`);k.state.transmissionRenderTarget[r.id]=new Yt(1,1,{generateMipmaps:!0,type:e?g:l,minFilter:c,samples:Math.max(4,Re.samples),stencilBuffer:i,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:It.workingColorSpace})}let a=k.state.transmissionRenderTarget[r.id],o=r.viewport||me;a.setSize(o.z*j.transmissionResolutionScale,o.w*j.transmissionResolutionScale);let s=j.getRenderTarget(),u=j.getActiveCubeFace(),d=j.getActiveMipmapLevel();j.setRenderTarget(a),j.getClearColor(_e),ve=j.getClearAlpha(),ve<1&&j.setClearColor(16777215,.5),j.clear(),Pe&&tt.render(n);let f=j.toneMapping;j.toneMapping=0;let p=r.viewport;if(r.viewport!==void 0&&(r.viewport=void 0),k.setupLightsView(r),Oe===!0&&Qe.setGlobalState(j.clippingPlanes,r),wt(e,n,r),I.updateMultisampleRenderTarget(a),I.updateRenderTargetMipmap(a),Le.has(`WEBGL_multisampled_render_to_texture`)===!1){let e=!1;for(let i=0,a=t.length;i<a;i++){let{object:a,geometry:o,material:s,group:c}=t[i];if(s.side===2&&a.layers.test(r.layers)){let t=s.side;s.side=1,s.needsUpdate=!0,Tt(a,n,r,o,s,c),s.side=t,s.needsUpdate=!0,e=!0}}e===!0&&(I.updateMultisampleRenderTarget(a),I.updateRenderTargetMipmap(a))}j.setRenderTarget(s,u,d),j.setClearColor(_e,ve),p!==void 0&&(r.viewport=p),j.toneMapping=f}function wt(e,t,n){let r=t.isScene===!0?t.overrideMaterial:null;for(let i=0,a=e.length;i<a;i++){let a=e[i],{object:o,geometry:s,group:c}=a,l=a.material;l.allowOverride===!0&&r!==null&&(l=r),o.layers.test(n.layers)&&Tt(o,t,n,s,l,c)}}function Tt(e,t,n,r,i,a){e.onBeforeRender(j,t,n,r,i,a),e.modelViewMatrix.multiplyMatrices(n.matrixWorldInverse,e.matrixWorld),e.normalMatrix.getNormalMatrix(e.modelViewMatrix),i.onBeforeRender(j,t,n,r,e,a),i.transparent===!0&&i.side===2&&i.forceSinglePass===!1?(i.side=1,i.needsUpdate=!0,j.renderBufferDirect(n,t,r,i,e,a),i.side=0,i.needsUpdate=!0,j.renderBufferDirect(n,t,r,i,e,a),i.side=2):j.renderBufferDirect(n,t,r,i,e,a),e.onAfterRender(j,t,n,r,i,a)}function Et(e,t,n){t.isScene!==!0&&(t=Ne);let r=F.get(e),i=k.state.lights,a=k.state.shadowsArray,o=i.state.version,s=Ke.getParameters(e,i.state,a,t,n,k.state.lightProbeGridArray),c=Ke.getProgramCacheKey(s),l=r.programs;r.environment=e.isMeshStandardMaterial||e.isMeshLambertMaterial||e.isMeshPhongMaterial?t.environment:null,r.fog=t.fog;let u=e.isMeshStandardMaterial||e.isMeshLambertMaterial&&!e.envMap||e.isMeshPhongMaterial&&!e.envMap;r.envMap=Ve.get(e.envMap||r.environment,u),r.envMapRotation=r.environment!==null&&e.envMap===null?t.environmentRotation:e.envMapRotation,l===void 0&&(e.addEventListener(`dispose`,ft),l=new Map,r.programs=l);let d=l.get(c);if(d!==void 0){if(r.currentProgram===d&&r.lightsStateVersion===o)return Ot(e,s),d}else s.uniforms=Ke.getUniforms(e),oe!==null&&e.isNodeMaterial&&oe.build(e,n,s),e.onBeforeCompile(s,j),d=Ke.acquireProgram(s,c),l.set(c,d),r.uniforms=s.uniforms;let f=r.uniforms;return(!e.isShaderMaterial&&!e.isRawShaderMaterial||e.clipping===!0)&&(f.clippingPlanes=Qe.uniform),Ot(e,s),r.needsLights=jt(e),r.lightsStateVersion=o,r.needsLights&&(f.ambientLightColor.value=i.state.ambient,f.lightProbe.value=i.state.probe,f.directionalLights.value=i.state.directional,f.directionalLightShadows.value=i.state.directionalShadow,f.spotLights.value=i.state.spot,f.spotLightShadows.value=i.state.spotShadow,f.rectAreaLights.value=i.state.rectArea,f.ltc_1.value=i.state.rectAreaLTC1,f.ltc_2.value=i.state.rectAreaLTC2,f.pointLights.value=i.state.point,f.pointLightShadows.value=i.state.pointShadow,f.hemisphereLights.value=i.state.hemi,f.directionalShadowMatrix.value=i.state.directionalShadowMatrix,f.spotLightMatrix.value=i.state.spotLightMatrix,f.spotLightMap.value=i.state.spotLightMap,f.pointShadowMatrix.value=i.state.pointShadowMatrix),r.lightProbeGrid=k.state.lightProbeGridArray.length>0,r.currentProgram=d,r.uniformsList=null,d}function Dt(e){if(e.uniformsList===null){let t=e.currentProgram.getUniforms();e.uniformsList=Vs.seqWithValue(t.seq,e.uniforms)}return e.uniformsList}function Ot(e,t){let n=F.get(e);n.outputColorSpace=t.outputColorSpace,n.batching=t.batching,n.batchingColor=t.batchingColor,n.instancing=t.instancing,n.instancingColor=t.instancingColor,n.instancingMorph=t.instancingMorph,n.skinning=t.skinning,n.morphTargets=t.morphTargets,n.morphNormals=t.morphNormals,n.morphColors=t.morphColors,n.morphTargetsCount=t.morphTargetsCount,n.numClippingPlanes=t.numClippingPlanes,n.numIntersection=t.numClipIntersection,n.vertexAlphas=t.vertexAlphas,n.vertexTangents=t.vertexTangents,n.toneMapping=t.toneMapping}function B(e,t){if(e.length===0)return null;if(e.length===1)return e[0].texture===null?null:e[0];D.setFromMatrixPosition(t.matrixWorld);for(let t=0,n=e.length;t<n;t++){let n=e[t];if(n.texture!==null&&n.boundingBox.containsPoint(D))return n}return null}function kt(e,t,n,r,i){t.isScene!==!0&&(t=Ne),I.resetTextureUnits();let a=t.fog,o=r.isMeshStandardMaterial||r.isMeshLambertMaterial||r.isMeshPhongMaterial?t.environment:null,s=M===null?j.outputColorSpace:M.isXRRenderTarget===!0?M.texture.colorSpace:It.workingColorSpace,c=r.isMeshStandardMaterial||r.isMeshLambertMaterial&&!r.envMap||r.isMeshPhongMaterial&&!r.envMap,l=Ve.get(r.envMap||o,c),u=r.vertexColors===!0&&!!n.attributes.color&&n.attributes.color.itemSize===4,d=!!n.attributes.tangent&&(!!r.normalMap||r.anisotropy>0),f=!!n.morphAttributes.position,p=!!n.morphAttributes.normal,m=!!n.morphAttributes.color,h=0;r.toneMapped&&(M===null||M.isXRRenderTarget===!0)&&(h=j.toneMapping);let g=n.morphAttributes.position||n.morphAttributes.normal||n.morphAttributes.color,_=g===void 0?0:g.length,v=F.get(r),y=k.state.lights;if(Oe===!0&&(ke===!0||e!==pe)){let t=e===pe&&r.id===fe;Qe.setState(r,e,t)}let b=!1;r.version===v.__version?v.needsLights&&v.lightsStateVersion!==y.state.version?b=!0:v.outputColorSpace===s?i.isBatchedMesh&&v.batching===!1||!i.isBatchedMesh&&v.batching===!0||i.isBatchedMesh&&v.batchingColor===!0&&i.colorTexture===null||i.isBatchedMesh&&v.batchingColor===!1&&i.colorTexture!==null||i.isInstancedMesh&&v.instancing===!1||!i.isInstancedMesh&&v.instancing===!0||i.isSkinnedMesh&&v.skinning===!1||!i.isSkinnedMesh&&v.skinning===!0||i.isInstancedMesh&&v.instancingColor===!0&&i.instanceColor===null||i.isInstancedMesh&&v.instancingColor===!1&&i.instanceColor!==null||i.isInstancedMesh&&v.instancingMorph===!0&&i.morphTexture===null||i.isInstancedMesh&&v.instancingMorph===!1&&i.morphTexture!==null?b=!0:v.envMap===l?r.fog===!0&&v.fog!==a||v.numClippingPlanes!==void 0&&(v.numClippingPlanes!==Qe.numPlanes||v.numIntersection!==Qe.numIntersection)?b=!0:v.vertexAlphas===u&&v.vertexTangents===d&&v.morphTargets===f&&v.morphNormals===p&&v.morphColors===m&&v.toneMapping===h&&v.morphTargetsCount===_?!!v.lightProbeGrid!=k.state.lightProbeGridArray.length>0&&(b=!0):b=!0:b=!0:b=!0:(b=!0,v.__version=r.version);let x=v.currentProgram;b===!0&&(x=Et(r,t,i),oe&&r.isNodeMaterial&&oe.onUpdateProgram(r,x,v));let S=!1,C=!1,w=!1,T=x.getUniforms(),E=v.uniforms;if(P.useProgram(x.program)&&(S=!0,C=!0,w=!0),r.id!==fe&&(fe=r.id,C=!0),v.needsLights){let e=B(k.state.lightProbeGridArray,i);v.lightProbeGrid!==e&&(v.lightProbeGrid=e,C=!0)}if(S||pe!==e){P.buffers.depth.getReversed()&&e.reversedDepth!==!0&&(e._reversedDepth=!0,e.updateProjectionMatrix()),T.setValue(N,`projectionMatrix`,e.projectionMatrix),T.setValue(N,`viewMatrix`,e.matrixWorldInverse);let t=T.map.cameraPosition;t!==void 0&&t.setValue(N,je.setFromMatrixPosition(e.matrixWorld)),Re.logarithmicDepthBuffer&&T.setValue(N,`logDepthBufFC`,2/(Math.log(e.far+1)/Math.LN2)),(r.isMeshPhongMaterial||r.isMeshToonMaterial||r.isMeshLambertMaterial||r.isMeshBasicMaterial||r.isMeshStandardMaterial||r.isShaderMaterial)&&T.setValue(N,`isOrthographic`,e.isOrthographicCamera===!0),pe!==e&&(pe=e,C=!0,w=!0)}if(v.needsLights&&(y.state.directionalShadowMap.length>0&&T.setValue(N,`directionalShadowMap`,y.state.directionalShadowMap,I),y.state.spotShadowMap.length>0&&T.setValue(N,`spotShadowMap`,y.state.spotShadowMap,I),y.state.pointShadowMap.length>0&&T.setValue(N,`pointShadowMap`,y.state.pointShadowMap,I)),i.isSkinnedMesh){T.setOptional(N,i,`bindMatrix`),T.setOptional(N,i,`bindMatrixInverse`);let e=i.skeleton;e&&(e.boneTexture===null&&e.computeBoneTexture(),T.setValue(N,`boneTexture`,e.boneTexture,I))}i.isBatchedMesh&&(T.setOptional(N,i,`batchingTexture`),T.setValue(N,`batchingTexture`,i._matricesTexture,I),T.setOptional(N,i,`batchingIdTexture`),T.setValue(N,`batchingIdTexture`,i._indirectTexture,I),T.setOptional(N,i,`batchingColorTexture`),i._colorsTexture!==null&&T.setValue(N,`batchingColorTexture`,i._colorsTexture,I));let D=n.morphAttributes;if((D.position!==void 0||D.normal!==void 0||D.color!==void 0)&&nt.update(i,n,x),(C||v.receiveShadow!==i.receiveShadow)&&(v.receiveShadow=i.receiveShadow,T.setValue(N,`receiveShadow`,i.receiveShadow)),(r.isMeshStandardMaterial||r.isMeshLambertMaterial||r.isMeshPhongMaterial)&&r.envMap===null&&t.environment!==null&&(E.envMapIntensity.value=t.environmentIntensity),E.dfgLUT!==void 0&&(E.dfgLUT.value=cl()),C){if(T.setValue(N,`toneMappingExposure`,j.toneMappingExposure),v.needsLights&&At(E,w),a&&r.fog===!0&&qe.refreshFogUniforms(E,a),qe.refreshMaterialUniforms(E,r,xe,be,k.state.transmissionRenderTarget[e.id]),v.needsLights&&v.lightProbeGrid){let e=v.lightProbeGrid;E.probesSH.value=e.texture,E.probesMin.value.copy(e.boundingBox.min),E.probesMax.value.copy(e.boundingBox.max),E.probesResolution.value.copy(e.resolution)}Vs.upload(N,Dt(v),E,I)}if(r.isShaderMaterial&&r.uniformsNeedUpdate===!0&&(Vs.upload(N,Dt(v),E,I),r.uniformsNeedUpdate=!1),r.isSpriteMaterial&&T.setValue(N,`center`,i.center),T.setValue(N,`modelViewMatrix`,i.modelViewMatrix),T.setValue(N,`normalMatrix`,i.normalMatrix),T.setValue(N,`modelMatrix`,i.matrixWorld),r.uniformsGroups!==void 0){let e=r.uniformsGroups;for(let t=0,n=e.length;t<n;t++){let n=e[t];st.update(n,x),st.bind(n,x)}}return x}function At(e,t){e.ambientLightColor.needsUpdate=t,e.lightProbe.needsUpdate=t,e.directionalLights.needsUpdate=t,e.directionalLightShadows.needsUpdate=t,e.pointLights.needsUpdate=t,e.pointLightShadows.needsUpdate=t,e.spotLights.needsUpdate=t,e.spotLightShadows.needsUpdate=t,e.rectAreaLights.needsUpdate=t,e.hemisphereLights.needsUpdate=t}function jt(e){return e.isMeshLambertMaterial||e.isMeshToonMaterial||e.isMeshPhongMaterial||e.isMeshStandardMaterial||e.isShadowMaterial||e.isShaderMaterial&&e.lights===!0}this.getActiveCubeFace=function(){return ue},this.getActiveMipmapLevel=function(){return de},this.getRenderTarget=function(){return M},this.setRenderTargetTextures=function(e,t,n){let r=F.get(e);r.__autoAllocateDepthBuffer=e.resolveDepthBuffer===!1,r.__autoAllocateDepthBuffer===!1&&(r.__useRenderToTexture=!1),F.get(e.texture).__webglTexture=t,F.get(e.depthTexture).__webglTexture=r.__autoAllocateDepthBuffer?void 0:n,r.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(e,t){let n=F.get(e);n.__webglFramebuffer=t,n.__useDefaultFramebuffer=t===void 0},this.setRenderTarget=function(e,t=0,n=0){M=e,ue=t,de=n;let r=null,i=!1,a=!1;if(e){let o=F.get(e);if(o.__useDefaultFramebuffer!==void 0){P.bindFramebuffer(N.FRAMEBUFFER,o.__webglFramebuffer),me.copy(e.viewport),he.copy(e.scissor),ge=e.scissorTest,P.viewport(me),P.scissor(he),P.setScissorTest(ge),fe=-1;return}else if(o.__webglFramebuffer===void 0)I.setupRenderTarget(e);else if(o.__hasExternalTextures)I.rebindTextures(e,F.get(e.texture).__webglTexture,F.get(e.depthTexture).__webglTexture);else if(e.depthBuffer){let t=e.depthTexture;if(o.__boundDepthTexture!==t){if(t!==null&&F.has(t)&&(e.width!==t.image.width||e.height!==t.image.height))throw Error(`THREE.WebGLRenderer: Attached DepthTexture is initialized to the incorrect size.`);I.setupDepthRenderbuffer(e)}}let s=e.texture;(s.isData3DTexture||s.isDataArrayTexture||s.isCompressedArrayTexture)&&(a=!0);let c=F.get(e).__webglFramebuffer;e.isWebGLCubeRenderTarget?(r=Array.isArray(c[t])?c[t][n]:c[t],i=!0):r=e.samples>0&&I.useMultisampledRTT(e)===!1?F.get(e).__webglMultisampledFramebuffer:Array.isArray(c)?c[n]:c,me.copy(e.viewport),he.copy(e.scissor),ge=e.scissorTest}else me.copy(we).multiplyScalar(xe).floor(),he.copy(Te).multiplyScalar(xe).floor(),ge=Ee;if(n!==0&&(r=se),P.bindFramebuffer(N.FRAMEBUFFER,r)&&P.drawBuffers(e,r),P.viewport(me),P.scissor(he),P.setScissorTest(ge),i){let r=F.get(e.texture);N.framebufferTexture2D(N.FRAMEBUFFER,N.COLOR_ATTACHMENT0,N.TEXTURE_CUBE_MAP_POSITIVE_X+t,r.__webglTexture,n)}else if(a){let r=t;for(let t=0;t<e.textures.length;t++){let i=F.get(e.textures[t]);N.framebufferTextureLayer(N.FRAMEBUFFER,N.COLOR_ATTACHMENT0+t,i.__webglTexture,n,r)}}else if(e!==null&&n!==0){let t=F.get(e.texture);N.framebufferTexture2D(N.FRAMEBUFFER,N.COLOR_ATTACHMENT0,N.TEXTURE_2D,t.__webglTexture,n)}fe=-1},this.readRenderTargetPixels=function(e,t,n,r,i,a,o,s=0){if(!(e&&e.isWebGLRenderTarget)){R(`WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.`);return}let c=F.get(e).__webglFramebuffer;if(e.isWebGLCubeRenderTarget&&o!==void 0&&(c=c[o]),c){P.bindFramebuffer(N.FRAMEBUFFER,c);try{let o=e.textures[s],c=o.format,l=o.type;if(e.textures.length>1&&N.readBuffer(N.COLOR_ATTACHMENT0+s),!Re.textureFormatReadable(c)){R(`WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.`);return}if(!Re.textureTypeReadable(l)){R(`WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.`);return}t>=0&&t<=e.width-r&&n>=0&&n<=e.height-i&&N.readPixels(t,n,r,i,at.convert(c),at.convert(l),a)}finally{let e=M===null?null:F.get(M).__webglFramebuffer;P.bindFramebuffer(N.FRAMEBUFFER,e)}}},this.readRenderTargetPixelsAsync=async function(e,t,n,r,i,a,o,s=0){if(!(e&&e.isWebGLRenderTarget))throw Error(`THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.`);let c=F.get(e).__webglFramebuffer;if(e.isWebGLCubeRenderTarget&&o!==void 0&&(c=c[o]),c)if(t>=0&&t<=e.width-r&&n>=0&&n<=e.height-i){P.bindFramebuffer(N.FRAMEBUFFER,c);let o=e.textures[s],l=o.format,u=o.type;if(e.textures.length>1&&N.readBuffer(N.COLOR_ATTACHMENT0+s),!Re.textureFormatReadable(l))throw Error(`THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.`);if(!Re.textureTypeReadable(u))throw Error(`THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.`);let d=N.createBuffer();N.bindBuffer(N.PIXEL_PACK_BUFFER,d),N.bufferData(N.PIXEL_PACK_BUFFER,a.byteLength,N.STREAM_READ),N.readPixels(t,n,r,i,at.convert(l),at.convert(u),0);let f=M===null?null:F.get(M).__webglFramebuffer;P.bindFramebuffer(N.FRAMEBUFFER,f);let p=N.fenceSync(N.SYNC_GPU_COMMANDS_COMPLETE,0);return N.flush(),await et(N,p,4),N.bindBuffer(N.PIXEL_PACK_BUFFER,d),N.getBufferSubData(N.PIXEL_PACK_BUFFER,0,a),N.deleteBuffer(d),N.deleteSync(p),a}else throw Error(`THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.`)},this.copyFramebufferToTexture=function(e,t=null,n=0){let r=2**-n,i=Math.floor(e.image.width*r),a=Math.floor(e.image.height*r),o=t===null?0:t.x,s=t===null?0:t.y;I.setTexture2D(e,0),N.copyTexSubImage2D(N.TEXTURE_2D,n,0,0,o,s,i,a),P.unbindTexture()},this.copyTextureToTexture=function(e,t,n=null,r=null,i=0,a=0){let o,s,c,l,u,d,f,p,m,h=e.isCompressedTexture?e.mipmaps[a]:e.image;if(n!==null)o=n.max.x-n.min.x,s=n.max.y-n.min.y,c=n.isBox3?n.max.z-n.min.z:1,l=n.min.x,u=n.min.y,d=n.isBox3?n.min.z:0;else{let t=2**-i;o=Math.floor(h.width*t),s=Math.floor(h.height*t),c=e.isDataArrayTexture?h.depth:e.isData3DTexture?Math.floor(h.depth*t):1,l=0,u=0,d=0}r===null?(f=0,p=0,m=0):(f=r.x,p=r.y,m=r.z);let g=at.convert(t.format),_=at.convert(t.type),v;t.isData3DTexture?(I.setTexture3D(t,0),v=N.TEXTURE_3D):t.isDataArrayTexture||t.isCompressedArrayTexture?(I.setTexture2DArray(t,0),v=N.TEXTURE_2D_ARRAY):(I.setTexture2D(t,0),v=N.TEXTURE_2D),P.activeTexture(N.TEXTURE0),P.pixelStorei(N.UNPACK_FLIP_Y_WEBGL,t.flipY),P.pixelStorei(N.UNPACK_PREMULTIPLY_ALPHA_WEBGL,t.premultiplyAlpha),P.pixelStorei(N.UNPACK_ALIGNMENT,t.unpackAlignment);let y=P.getParameter(N.UNPACK_ROW_LENGTH),b=P.getParameter(N.UNPACK_IMAGE_HEIGHT),x=P.getParameter(N.UNPACK_SKIP_PIXELS),S=P.getParameter(N.UNPACK_SKIP_ROWS),C=P.getParameter(N.UNPACK_SKIP_IMAGES);P.pixelStorei(N.UNPACK_ROW_LENGTH,h.width),P.pixelStorei(N.UNPACK_IMAGE_HEIGHT,h.height),P.pixelStorei(N.UNPACK_SKIP_PIXELS,l),P.pixelStorei(N.UNPACK_SKIP_ROWS,u),P.pixelStorei(N.UNPACK_SKIP_IMAGES,d);let w=e.isDataArrayTexture||e.isData3DTexture,T=t.isDataArrayTexture||t.isData3DTexture;if(e.isDepthTexture){let n=F.get(e),r=F.get(t),h=F.get(n.__renderTarget),g=F.get(r.__renderTarget);P.bindFramebuffer(N.READ_FRAMEBUFFER,h.__webglFramebuffer),P.bindFramebuffer(N.DRAW_FRAMEBUFFER,g.__webglFramebuffer);for(let n=0;n<c;n++)w&&(N.framebufferTextureLayer(N.READ_FRAMEBUFFER,N.COLOR_ATTACHMENT0,F.get(e).__webglTexture,i,d+n),N.framebufferTextureLayer(N.DRAW_FRAMEBUFFER,N.COLOR_ATTACHMENT0,F.get(t).__webglTexture,a,m+n)),N.blitFramebuffer(l,u,o,s,f,p,o,s,N.DEPTH_BUFFER_BIT,N.NEAREST);P.bindFramebuffer(N.READ_FRAMEBUFFER,null),P.bindFramebuffer(N.DRAW_FRAMEBUFFER,null)}else if(i!==0||e.isRenderTargetTexture||F.has(e)){let n=F.get(e),r=F.get(t);P.bindFramebuffer(N.READ_FRAMEBUFFER,ce),P.bindFramebuffer(N.DRAW_FRAMEBUFFER,le);for(let e=0;e<c;e++)w?N.framebufferTextureLayer(N.READ_FRAMEBUFFER,N.COLOR_ATTACHMENT0,n.__webglTexture,i,d+e):N.framebufferTexture2D(N.READ_FRAMEBUFFER,N.COLOR_ATTACHMENT0,N.TEXTURE_2D,n.__webglTexture,i),T?N.framebufferTextureLayer(N.DRAW_FRAMEBUFFER,N.COLOR_ATTACHMENT0,r.__webglTexture,a,m+e):N.framebufferTexture2D(N.DRAW_FRAMEBUFFER,N.COLOR_ATTACHMENT0,N.TEXTURE_2D,r.__webglTexture,a),i===0?T?N.copyTexSubImage3D(v,a,f,p,m+e,l,u,o,s):N.copyTexSubImage2D(v,a,f,p,l,u,o,s):N.blitFramebuffer(l,u,o,s,f,p,o,s,N.COLOR_BUFFER_BIT,N.NEAREST);P.bindFramebuffer(N.READ_FRAMEBUFFER,null),P.bindFramebuffer(N.DRAW_FRAMEBUFFER,null)}else T?e.isDataTexture||e.isData3DTexture?N.texSubImage3D(v,a,f,p,m,o,s,c,g,_,h.data):t.isCompressedArrayTexture?N.compressedTexSubImage3D(v,a,f,p,m,o,s,c,g,h.data):N.texSubImage3D(v,a,f,p,m,o,s,c,g,_,h):e.isDataTexture?N.texSubImage2D(N.TEXTURE_2D,a,f,p,o,s,g,_,h.data):e.isCompressedTexture?N.compressedTexSubImage2D(N.TEXTURE_2D,a,f,p,h.width,h.height,g,h.data):N.texSubImage2D(N.TEXTURE_2D,a,f,p,o,s,g,_,h);P.pixelStorei(N.UNPACK_ROW_LENGTH,y),P.pixelStorei(N.UNPACK_IMAGE_HEIGHT,b),P.pixelStorei(N.UNPACK_SKIP_PIXELS,x),P.pixelStorei(N.UNPACK_SKIP_ROWS,S),P.pixelStorei(N.UNPACK_SKIP_IMAGES,C),a===0&&t.generateMipmaps&&N.generateMipmap(v),P.unbindTexture()},this.initRenderTarget=function(e){F.get(e).__webglFramebuffer===void 0&&I.setupRenderTarget(e)},this.initTexture=function(e){e.isCubeTexture?I.setTextureCube(e,0):e.isData3DTexture?I.setTexture3D(e,0):e.isDataArrayTexture||e.isCompressedArrayTexture?I.setTexture2DArray(e,0):I.setTexture2D(e,0),P.unbindTexture()},this.resetState=function(){ue=0,de=0,M=null,P.reset(),ot.reset()},typeof __THREE_DEVTOOLS__<`u`&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent(`observe`,{detail:this}))}get coordinateSystem(){return Ge}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;let t=this.getContext();t.drawingBufferColorSpace=It._getDrawingBufferColorSpace(e),t.unpackColorSpace=It._getUnpackColorSpace()}};function ul(e,t=!1){let n=e[0].index!==null,r=new Set(Object.keys(e[0].attributes)),i=new Set(Object.keys(e[0].morphAttributes)),a={},o={},s=e[0].morphTargetsRelative,c=new Or,l=0;for(let u=0;u<e.length;++u){let d=e[u],f=0;if(n!==(d.index!==null))return console.error(`THREE.BufferGeometryUtils: .mergeGeometries() failed with geometry at index `+u+`. All geometries must have compatible attributes; make sure index attribute exists among all geometries, or in none of them.`),null;for(let e in d.attributes){if(!r.has(e))return console.error(`THREE.BufferGeometryUtils: .mergeGeometries() failed with geometry at index `+u+`. All geometries must have compatible attributes; make sure "`+e+`" attribute exists among all geometries, or in none of them.`),null;a[e]===void 0&&(a[e]=[]),a[e].push(d.attributes[e]),f++}if(f!==r.size)return console.error(`THREE.BufferGeometryUtils: .mergeGeometries() failed with geometry at index `+u+`. Make sure all geometries have the same number of attributes.`),null;if(s!==d.morphTargetsRelative)return console.error(`THREE.BufferGeometryUtils: .mergeGeometries() failed with geometry at index `+u+`. .morphTargetsRelative must be consistent throughout all geometries.`),null;for(let e in d.morphAttributes){if(!i.has(e))return console.error(`THREE.BufferGeometryUtils: .mergeGeometries() failed with geometry at index `+u+`.  .morphAttributes must be consistent throughout all geometries.`),null;o[e]===void 0&&(o[e]=[]),o[e].push(d.morphAttributes[e])}if(t){let e;if(n)e=d.index.count;else if(d.attributes.position!==void 0)e=d.attributes.position.count;else return console.error(`THREE.BufferGeometryUtils: .mergeGeometries() failed with geometry at index `+u+`. The geometry must have either an index or a position attribute`),null;c.addGroup(l,e,u),l+=e}}if(n){let t=0,n=[];for(let r=0;r<e.length;++r){let i=e[r].index;for(let e=0;e<i.count;++e)n.push(i.getX(e)+t);t+=e[r].attributes.position.count}c.setIndex(n)}for(let e in a){let t=dl(a[e]);if(!t)return console.error(`THREE.BufferGeometryUtils: .mergeGeometries() failed while trying to merge the `+e+` attribute.`),null;c.setAttribute(e,t)}for(let e in o){let t=o[e][0].length;if(t!==0){c.morphAttributes=c.morphAttributes||{},c.morphAttributes[e]=[];for(let n=0;n<t;++n){let t=[];for(let r=0;r<o[e].length;++r)t.push(o[e][r][n]);let r=dl(t);if(!r)return console.error(`THREE.BufferGeometryUtils: .mergeGeometries() failed while trying to merge the `+e+` morphAttribute.`),null;c.morphAttributes[e].push(r)}}}return c}function dl(e){let t,n,r,i=-1,a=0;for(let o=0;o<e.length;++o){let s=e[o];if(t===void 0&&(t=s.array.constructor),t!==s.array.constructor)return console.error(`THREE.BufferGeometryUtils: .mergeAttributes() failed. BufferAttribute.array must be of consistent array types across matching attributes.`),null;if(n===void 0&&(n=s.itemSize),n!==s.itemSize)return console.error(`THREE.BufferGeometryUtils: .mergeAttributes() failed. BufferAttribute.itemSize must be consistent across matching attributes.`),null;if(r===void 0&&(r=s.normalized),r!==s.normalized)return console.error(`THREE.BufferGeometryUtils: .mergeAttributes() failed. BufferAttribute.normalized must be consistent across matching attributes.`),null;if(i===-1&&(i=s.gpuType),i!==s.gpuType)return console.error(`THREE.BufferGeometryUtils: .mergeAttributes() failed. BufferAttribute.gpuType must be consistent across matching attributes.`),null;a+=s.count*n}let o=new t(a),s=new pr(o,n,r),c=0;for(let t=0;t<e.length;++t){let r=e[t];if(r.isInterleavedBufferAttribute){let e=c/n;for(let t=0,i=r.count;t<i;t++)for(let i=0;i<n;i++){let n=r.getComponent(t,i);s.setComponent(t+e,i,n)}}else o.set(r.array,c);c+=r.count*n}return i!==void 0&&(s.gpuType=i),s}var fl=new Map,pl=new Map;function q(e,t={}){let n=`${e}|${JSON.stringify(t)}`,r=fl.get(n);return r||(r=new Ui({color:e,roughness:.78,metalness:.04,...t}),fl.set(n,r)),r}function ml(e,t){let n=pl.get(e);return n||(n=t(),pl.set(e,n)),n}function hl(e,t,n){return t&&e.position.set(t[0],t[1],t[2]),n&&e.rotation.set(n[0],n[1],n[2]),e.castShadow=!0,e.receiveShadow=!0,e}function J(e,t,n,r,i,a){return hl(new Zr(ml(`box|${e}|${t}|${n}`,()=>new Ci(e,t,n)),r),i,a)}function gl(e,t,n,r,i,a,o=16){return hl(new Zr(ml(`cyl|${e}|${t}|${n}|${o}`,()=>new wi(e,t,n,o)),r),i,a)}function _l(e,t,n,r=12){return hl(new Zr(ml(`sph|${e}|${r}`,()=>new ji(e,r,Math.max(6,Math.round(r*.6)))),t),n)}function vl(e,t,n,r=14){return hl(new Zr(ml(`dome|${e}|${r}`,()=>new ji(e,r,8,0,Math.PI*2,0,Math.PI/2)),t),n)}function yl(e,t,n){return hl(new Zr(ml(`ico|${e}`,()=>new Di(e,0)),t),n)}function bl(e,t,n,r,i,a=8){return hl(new Zr(ml(`cone|${e}|${t}|${a}`,()=>new Ti(e,t,a)),n),r,i)}function xl(e,t,n,r,i){let a=new Zr(ml(`plane|${e}|${t}`,()=>new Ai(e,t)),n);return r&&a.position.set(r[0],r[1],r[2]),i&&a.rotation.set(i[0],i[1],i[2]),a.receiveShadow=!0,a}function Sl(e,t,n=24){return hl(new Zr(new Oi(e.map(e=>new B(e[0],e[1])),n),t))}function Cl(e=[]){let t=new U;return e.forEach(e=>t.add(e)),t}function wl(e,t){let n=new Zr(ul(e),t);return n.receiveShadow=!0,n}function Tl(e){e.updateMatrixWorld(!0);let t=new Map;return e.traverse(e=>{if(!e.isMesh)return;let n=e.material,r=[n.color?n.color.getHex():0,+!!n.flatShading,n.roughness,n.metalness,+!!n.transparent].join(`|`);t.has(r)||t.set(r,{material:n,geometries:[]});let i=e.geometry.index?e.geometry.toNonIndexed():e.geometry.clone();i.applyMatrix4(e.matrixWorld),t.get(r).geometries.push(i)}),[...t.values()].map(e=>({geometry:e.geometries.length===1?e.geometries[0]:ul(e.geometries),material:e.material}))}function El(e){return e.traverse(e=>{e.isMesh&&(e.material=e.material.clone(),e.userData.baseEmissive=e.material.emissive.clone())}),e}function Dl(e,t){e.traverse(e=>{!e.isMesh||!e.userData.baseEmissive||(t?(e.material.emissive.setHex(3811856),e.material.emissiveIntensity=1.1):(e.material.emissive.copy(e.userData.baseEmissive),e.material.emissiveIntensity=1))})}var Y={minX:-3.15,maxX:3.05,minZ:-3,maxZ:3.4,height:2.75,back:1,left:.85,right:-.75,front:-.6},Ol={minX:Y.minX+.28,maxX:Y.maxX-.28,minZ:Y.minZ+.28,maxZ:Y.maxZ-.28},kl=Y.height,Al=q(10251071,{roughness:.85}),jl=q(12618322,{roughness:.8}),Ml=q(14264426,{roughness:.75}),Nl=q(15853786,{roughness:.5}),Pl=q(16511716,{roughness:.95}),Fl=q(16644076,{roughness:.95}),Il=q(12897491,{metalness:.5,roughness:.3}),Ll=q(14870508,{metalness:.55,roughness:.18}),Rl=q(12173769,{metalness:.4,roughness:.4}),zl=q(14541800,{metalness:.28,roughness:.32}),Bl=q(3422013,{roughness:.6,metalness:.25}),Vl=q(16249834,{roughness:.35}),Hl=q(15331058,{roughness:.45,metalness:.15}),Ul=q(6990152,{roughness:.9,flatShading:!0}),Wl=q(11132149,{emissive:8833520,emissiveIntensity:.25,roughness:.2,transparent:!0,opacity:.32,depthWrite:!1}),Gl=new zr({transparent:!0,opacity:0,depthWrite:!1}),Kl=q(3356477,{metalness:.55,roughness:.42}),ql=q(4869975,{metalness:.42,roughness:.5}),Jl=q(9399103,{roughness:.8}),Yl=q(16751150,{emissive:16736768,emissiveIntensity:.85,roughness:.6});function Xl(){let e=new U,t=(Y.minX+Y.maxX)/2,n=(Y.minZ+Y.maxZ)/2,r=Y.maxX-Y.minX,i=Y.maxZ-Y.minZ;e.add(J(r,.1,i,q(9265718,{roughness:.9}),[t,-.05,n]));let a=Math.floor(r/1)+1;return[13213802,12489049].forEach((t,r)=>{let o=[];for(let e=r;e<a;e+=2)o.push(new Ci(.98,.04,i-.1).translate(Y.minX+.5+e,.02,n));e.add(wl(o,q(t,{roughness:.85})))}),e}function Zl(){let e=new U,t=(Y.minX+Y.maxX)/2,n=(Y.minZ+Y.maxZ)/2,r=Y.maxX-Y.minX,i=Y.maxZ-Y.minZ,a=(t,n,r)=>{let i=xl(t,kl,Pl,n,r);i.castShadow=!1,e.add(i)};a(r,[t,kl/2,Y.minZ],[0,0,0]),a(r,[t,kl/2,Y.maxZ],[0,Math.PI,0]),a(i,[Y.minX,kl/2,n],[0,Math.PI/2,0]),a(i,[Y.maxX,kl/2,n],[0,-Math.PI/2,0]);let o=xl(r,i,Fl,[t,kl,n],[Math.PI/2,0,0]);o.castShadow=!1,e.add(o);let s=kl-.09;return e.add(J(r,.18,.08,Ml,[t,s,Y.minZ+.04])),e.add(J(r,.18,.08,Ml,[t,s,Y.maxZ-.04])),e.add(J(.08,.18,i,Ml,[Y.minX+.04,s,n])),e.add(J(.08,.18,i,Ml,[Y.maxX-.04,s,n])),e.add(J(r,.16,.1,Ml,[t,.08,Y.minZ+.06])),e.add(J(r,.16,.1,Ml,[t,.08,Y.maxZ-.06])),e.add(J(.1,.16,i,Ml,[Y.minX+.06,.08,n])),e.add(J(.1,.16,i,Ml,[Y.maxX-.06,.08,n])),e}var Ql=null;function $l(){if(Ql)return Ql;let e=document.createElement(`canvas`);e.width=256,e.height=192;let t=e.getContext(`2d`),n=t.createLinearGradient(0,0,0,e.height);n.addColorStop(0,`#7fbde8`),n.addColorStop(.55,`#bfe0f2`),n.addColorStop(1,`#f4e6cc`),t.fillStyle=n,t.fillRect(0,0,e.width,e.height),t.fillStyle=`rgba(255, 246, 214, 0.95)`,t.beginPath(),t.arc(188,46,18,0,Math.PI*2),t.fill(),[{y:132,color:`#8fae86`,points:[[0,132],[42,104],[86,130],[128,96],[176,128],[216,108],[256,134]]},{y:150,color:`#6f9469`,points:[[0,152],[56,124],[110,150],[164,122],[214,148],[256,132]]},{y:168,color:`#5b7f5a`,points:[[0,176],[70,148],[140,172],[206,146],[256,168]]}].forEach(n=>{t.fillStyle=n.color,t.beginPath(),t.moveTo(0,e.height),n.points.forEach(e=>t.lineTo(e[0],e[1])),t.lineTo(e.width,e.height),t.closePath(),t.fill()});let r=new yi(e);return r.colorSpace=Be,r.anisotropy=4,Ql=new zr({map:r}),Ql}function eu(){let e=new U,t=-3.95;return e.add(xl(1.24,.94,$l(),[-3.994,1.85,2.2],[0,Math.PI/2,0])),e.add(xl(1.24,.94,Wl,[-3.986,1.85,2.2],[0,Math.PI/2,0])),e.add(J(.06,1.06,.08,Ml,[t,1.85,1.57])),e.add(J(.06,1.06,.08,Ml,[t,1.85,2.83])),e.add(J(.06,.08,1.34,Ml,[t,1.34,2.2])),e.add(J(.06,.08,1.34,Ml,[t,2.36,2.2])),e.add(J(.04,.9,.05,Ml,[t,1.85,2.2])),e.add(J(.16,.05,1.44,Ml,[-3.9,1.31,2.2])),e.add(J(.1,.04,1.5,q(15984335,{roughness:.7}),[-3.88,1.28,2.2])),e}function tu(){let e=new U,t=-2.7;return e.add(J(.1,2.34,.16,Ml,[t-.55,1.17,3.86])),e.add(J(.1,2.34,.16,Ml,[-2.1500000000000004,1.17,3.86])),e.add(J(1.24,.14,.18,Ml,[t,2.35,3.86])),e.add(J(1,2.28,.07,jl,[t,1.14,3.84])),e.add(J(.68,.72,.03,Al,[t,1.63,3.795])),e.add(J(.68,.8,.03,Al,[t,.68,3.795])),e.add(gl(.032,.032,.08,Il,[-2.33,1.08,3.79],[Math.PI/2,0,0],10)),e.add(J(.09,.09,.02,Il,[-2.33,1.08,3.82])),e.add(J(1.24,.05,.26,Al,[t,.025,3.86])),e}function nu(){let e=Y.back,t=Y.left,n=Y.right,r=Y.front;return[{minX:Y.minX,maxX:2.62,minZ:Y.minZ,maxZ:-3.3+e},{minX:2.92+n,maxX:Y.maxX,minZ:-2.1,maxZ:-1.05},{minX:Y.minX,maxX:-3.25+t,minZ:-2.35,maxZ:1.6},{minX:-1.32,maxX:1.32,minZ:-.72,maxZ:.72},{minX:-3.85+t,maxX:-3.43+t,minZ:3.43+r,maxZ:Y.maxZ}]}function ru(){let e=new U,t=-2.1,n={min:-3.99,max:t-.45},r={min:t-.45,max:-1.6500000000000001},i={min:-1.6500000000000001,max:2.6},a=(e,t,n,r,i,a)=>J(e.max-e.min,t,r,a,[(e.min+e.max)/2,n,i]);return e.add(a(n,.86,.43,.62,-3.68,jl)),e.add(a(r,.7,.35,.62,-3.68,jl)),e.add(a(r,.18,.78,.05,-3.395,jl)),e.add(a(i,.86,.43,.62,-3.68,jl)),e.add(a(n,.06,.89,.7,-3.66,Nl)),e.add(a(i,.06,.89,.7,-3.66,Nl)),e.add(a(r,.06,.89,.16,-3.93,Nl)),e.add(a(r,.06,.89,.07,-3.345,Nl)),[{x:-3.64,width:.68},{x:-2.9,width:.68},{x:-1.4,width:.46},{x:1.06,width:.56},{x:1.68,width:.56},{x:2.3,width:.56}].forEach(t=>{e.add(J(t.width,.6,.04,Ml,[t.x,.46,-3.35])),e.add(J(.22,.03,.03,Il,[t.x,.68,-3.31]))}),e.add(J(1.9,.62,.05,Bl,[-.2,.45,-3.345])),e.add(J(1.6,.34,.02,q(1911347,{roughness:.2,metalness:.5}),[-.2,.42,-3.305])),e.add(J(1.5,.05,.06,Il,[-.2,.7,-3.29])),e.add(J(.34,.05,.02,q(657946,{emissive:1724415,emissiveIntensity:.4}),[.5,.42,-3.3])),e}function iu(){let e=new U;e.add(J(2.3,.72,.36,Ml,[1.75,1.92,-3.8])),e.add(J(2.1,.02,.38,Al,[1.75,1.56,-3.79])),[.95,1.7,2.45].forEach(t=>{e.add(J(.7,.62,.03,jl,[t,1.92,-3.61])),e.add(J(.16,.025,.03,Il,[t,1.62,-3.58]))});let t=1.72;return e.add(J(2.4,.08,.42,Al,[-2.3,t,-3.79])),e.add(J(.06,.2,.3,Al,[-3.3,t-.13,-3.85])),e.add(J(.06,.2,.3,Al,[-1.3,t-.13,-3.85])),[9420650,14197084,13198159].forEach((t,n)=>{let r=-2.9+n*.18;e.add(gl(.06,.06,.16,q(t,{roughness:.5}),[r,1.8399999999999999,-3.79],null,12)),e.add(gl(.065,.065,.02,Al,[r,1.93,-3.79],null,12))}),e}function au(){let e=new U,t=-2.6,n=-3.615;e.add(J(.88,.03,.47,zl,[t,.72,n])),e.add(J(.03,.19,.47,zl,[t-.445,.815,n])),e.add(J(.03,.19,.47,zl,[-2.1550000000000002,.815,n])),e.add(J(.92,.19,.03,zl,[t,.815,-3.835])),e.add(J(.92,.19,.03,zl,[t,.815,-3.395])),e.add(gl(.035,.035,.012,q(6055019,{metalness:.7,roughness:.4}),[t,.737,n],null,16)),e.add(J(.05,.02,.5,Il,[t-.46,.925,n])),e.add(J(.05,.02,.5,Il,[-2.14,.925,n])),e.add(J(.97,.02,.05,Il,[t,.925,-3.845])),e.add(J(.97,.02,.05,Il,[t,.925,-3.385])),e.add(gl(.05,.055,.02,Il,[t,.93,-3.93],null,18)),e.add(gl(.018,.018,.37,Ll,[t,1.115,-3.93],null,14)),e.add(_l(.024,Ll,[t,1.3,-3.93],10)),e.add(gl(.018,.018,.2,Ll,[t,1.3,-3.83],[Math.PI/2,0,0],14)),e.add(_l(.024,Ll,[t,1.3,-3.73],10)),e.add(gl(.016,.016,.1,Ll,[t,1.25,-3.73],null,14)),e.add(gl(.014,.018,.03,Rl,[t,1.185,-3.73],null,12)),e.add(gl(.026,.026,.05,Ll,[t,1.06,-3.93],null,12)),e.add(gl(.013,.013,.16,Ll,[t-.076,1.035,-3.93],[0,0,Math.PI/2+.32],12)),e.add(_l(.017,Ll,[t-.152,1.01,-3.93],10));let r=new Zr(new Ci(.98,.14,.6),Gl);r.position.set(t,.9,n),e.add(r);let i=new U;return i.visible=!1,[[-.16,.06],[-.06,-.08],[.04,.09],[.14,-.03],[0,.02]].forEach((e,r)=>{i.add(_l(.03+r%3*.008,q(16777215,{transparent:!0,opacity:.72,roughness:.2}),[t+e[0],.79+r%3*.015,n+e[1]],10))}),e.add(i),e.userData.sinkStation={hitbox:r,bubbles:i,position:new V(t,.9,n)},e}var ou=22,su=[[0,-.058],[.118,-.058],[.146,-.048],[.168,.004],[.176,.014],[.177,.018],[.172,.02],[.169,.014],[.15,-.01],[.138,-.026]],cu=[[.138,-.026],[.1,-.029],[.05,-.03],[0,-.03]];function lu(e){let t=new U;t.position.set(e,1.04,-3.66);let n=new U;return n.add(Sl(su,Kl,ou)),n.add(Sl(cu,ql,ou)),n.add(J(.035,.022,.16,Jl,[0,.004,.24])),t.add(n),t.userData.body=n,t}function uu(e){let t=new U;t.position.set(e,.99,-3.66);for(let e=0;e<12;e+=1){let n=new U;n.rotation.y=-(e/12)*Math.PI*2,n.add(bl(.023,.082,Yl,[.183,.041,0],[0,0,-.18],6)),t.add(n)}return t}function du(){let e=new U;e.add(J(1.5,.05,.62,Bl,[-.2,.945,-3.66])),[-.6,.2].forEach(t=>{e.add(gl(.17,.17,.012,q(5264732,{metalness:.6,roughness:.4}),[t,.975,-3.66],null,20)),e.add(gl(.13,.13,.006,q(2764081,{roughness:.5}),[t,.982,-3.66],null,20))});let t=lu(-.6),n=lu(.2),r=uu(-.6);r.visible=!1,r.traverse(e=>{e.isMesh&&(e.castShadow=!1)});let i=uu(.2);i.visible=!1,i.traverse(e=>{e.isMesh&&(e.castShadow=!1)});let a=new Sa(16751164,0,2.3,2);a.position.set(-.6,1.06,-3.62);let o=new Sa(16751164,0,2.3,2);o.position.set(.2,1.06,-3.62),e.add(t,n,r,i,a,o),e.add(J(.5,.04,.06,Il,[-.2,1.02,-3.9]));let s=new Zr(new Ci(.8,.9,1),Gl);s.position.set(-.6,1.05,-3.5),e.add(s);let c=new Zr(new Ci(.8,.9,1),Gl);return c.position.set(.2,1.05,-3.5),e.add(c),e.userData.hitboxLeft=s,e.userData.hitboxRight=c,e.userData.panLeft=t,e.userData.panRight=n,e.userData.flameLeft=r,e.userData.flameRight=i,e.userData.flameLightLeft=a,e.userData.flameLightRight=o,e}function fu(){let e=new U;return e.add(J(1.3,.18,.58,Il,[-.2,2.02,-3.7])),e.add(J(.46,.64,.4,Il,[-.2,2.43,-3.78])),e.add(J(1.24,.03,.1,q(16774102,{emissive:16769184,emissiveIntensity:.85}),[-.2,1.93,-3.62])),e.add(J(.9,.05,.04,Bl,[-.2,1.9,-3.5])),e}var pu=.72,mu=.03;function hu(e,t){t.updateWorldMatrix(!0,!1);let n=1/0,r=-1/0,i=1/0,a=-1/0;return[[-.03,0],[mu,0],[-.03,pu],[mu,pu]].forEach(e=>{let o=new V(e[0],0,e[1]).applyMatrix4(t.matrixWorld);n=Math.min(n,o.x),r=Math.max(r,o.x),i=Math.min(i,o.z),a=Math.max(a,o.z)}),e.minX=n-.03,e.maxX=r+.03,e.minZ=i-.03,e.maxZ=a+.03,e}function gu(){let e=new U,t=3.4,n=-1.6;e.add(J(.72,.08,.68,q(3356477,{roughness:.75}),[t,.04,n])),e.add(J(.8,.05,.76,Hl,[t,.105,n])),e.add(J(.8,.06,.76,Hl,[t,1.75,n])),e.add(J(.06,1.59,.76,Hl,[3.77,.925,n])),e.add(J(.74,1.59,.05,Hl,[3.37,.925,-1.955])),e.add(J(.74,1.59,.05,Hl,[3.37,.925,-1.245])),e.add(J(.05,.02,.7,q(12831698,{roughness:.5}),[3.01,.005,n])),[.46,.9,1.34].forEach(t=>{e.add(J(.62,.025,.64,q(14673642,{roughness:.4}),[3.38,t,n]))}),e.add(J(.5,.02,.5,q(16774880,{emissive:16771517,emissiveIntensity:1.1}),[3.38,1.7,n]));let r=new U;r.position.set(3.02,.89,-1.955),r.add(J(.06,1.7,.72,Hl,[0,0,.36])),r.add(J(.03,.9,.05,Il,[-.06,-.1,.64])),r.add(J(.02,.16,.3,q(2764598,{emissive:1993727,emissiveIntensity:.35}),[-.035,.52,.3]));let i=new Zr(new Ci(.14,1.7,.74),Gl);i.position.set(-.02,0,.36),r.add(i),e.add(r);let a={minX:0,maxX:0,minZ:0,maxZ:0};return hu(a,r),e.userData.doorPivot=r,e.userData.doorHitbox=i,e.userData.doorArea=a,e}function _u(){let e=new U;return e.add(J(.62,.86,3.85,jl,[-3.68,.43,-.425])),e.add(J(.68,.06,3.9,Nl,[-3.65,.89,-.4])),[-1.9,-1,-.1,.9].forEach(t=>{e.add(J(.04,.58,.86,Ml,[-3.35,.46,t])),e.add(J(.03,.03,.2,Il,[-3.32,.7,t]))}),e.add(J(.5,.07,.9,Al,[-3.75,1.85,-1.4])),e.add(J(.16,.2,.06,Al,[-3.92,1.72,-1.75])),e.add(J(.16,.2,.06,Al,[-3.92,1.72,-1.05])),e.add(gl(.07,.07,.14,q(14197084,{roughness:.5}),[-3.7,1.96,-1.4],null,12)),e.add(gl(.075,.075,.02,Al,[-3.7,2.04,-1.4],null,12)),e}function vu(){let e=new U;e.add(J(2.4,.86,1.2,jl,[0,.43,0])),e.add(J(2.52,.06,1.32,Nl,[0,.89,0])),e.add(J(2.2,.5,.04,Ml,[0,.45,-.59])),e.add(J(.44,.035,.32,q(14465159,{roughness:.7}),[.6,.9375,0]));let t=new U;t.position.set(.6,.955,-.03),t.rotation.y=Math.PI,t.add(J(.024,.006,.16,Il,[0,0,-.11])),t.add(J(.022,.026,.09,q(2894896,{roughness:.5}),[0,.002,-.005])),e.add(t);let n=new U;n.visible=!1,e.add(n);let r=new Zr(new Ci(.62,.4,.5),Gl);return r.position.set(.6,1.12,.04),e.add(r),e.userData.chopStation={hitbox:r,knife:t,bits:n,position:new V(.6,.955,0)},e.add(gl(.09,.07,.06,Vl,[-1,.95,0],null,16)),e}function yu(){let e=new U;e.add(gl(.17,.14,.26,q(12873791,{roughness:.85}),[-3.64,.13,3.64],null,12)),e.add(gl(.18,.18,.03,q(11033651,{roughness:.85}),[-3.64,.275,3.64],null,12));for(let t=0;t<5;t+=1){let n=t*Math.PI*2/5,r=J(.06,.36,.02,Ul,[-3.64+Math.cos(n)*.05,.46,3.64+Math.sin(n)*.05],[0,n,.18]);e.add(r)}return e}function bu(){let e=new U;e.add(gl(.012,.012,.28,q(2894896,{roughness:.6}),[0,2.63,0],null,8)),e.add(gl(.16,.08,.06,q(2894896,{roughness:.6}),[0,2.72,0],null,12));let t=new Zr(new Ti(.3,.26,18,1,!0),q(12873791,{roughness:.7,side:2}));return t.position.set(0,2.6,0),t.castShadow=!1,e.add(t),e.add(gl(.06,.06,.04,q(16773327,{emissive:16767392,emissiveIntensity:1.1}),[0,2.5,0],null,10)),e.traverse(e=>{e.isMesh&&(e.castShadow=!1)}),e}function xu(){let e=new U,t=new Sa(16768174,46,24,1.75);return t.position.set(0,2.42,0),t.castShadow=!0,t.shadow.mapSize.set(1024,1024),t.shadow.camera.near=.16,t.shadow.camera.far=15,t.shadow.bias=-.0012,t.shadow.normalBias=.012,t.shadow.radius=2,t.shadow.intensity=.8,e.add(t),e.add(new wa(16773598,.42)),e}function Su(){let e=new U,t=du(),n=gu(),r=vu(),i=au(),a=ru(),o=iu(),s=fu(),c=_u(),l=yu(),u=bu(),d=eu(),f=tu();a.position.z=Y.back,o.position.z=Y.back,s.position.z=Y.back,i.position.z=Y.back,t.position.z=Y.back,c.position.x=Y.left,d.position.x=Y.left,l.position.x=Y.left,l.position.z=Y.front,n.position.x=Y.right,i.position.x=.5,f.position.z=Y.front,f.position.x=1,e.add(Xl(),Zl(),a,o,i,t,s,n,c,r,l,u,d,f,xu());let p=3.32+Y.right;return{root:e,ingredientSpots:[{ingredientId:`cabbage`,position:new V(p,.08,-1.76),cols:2,rows:2},{ingredientId:`potato`,position:new V(p,.08,-1.44),cols:3,rows:3},{ingredientId:`tomato`,position:new V(p,.4725,-1.76),cols:4,rows:5},{ingredientId:`egg`,position:new V(p,.4725,-1.44),cols:5,rows:5},{ingredientId:`carrot`,position:new V(p,.9125,-1.76),cols:5,rows:2},{ingredientId:`mushroom`,position:new V(p,.9125,-1.44),cols:5,rows:4},{ingredientId:`beef`,position:new V(p,1.3525,-1.76),cols:2,rows:2},{ingredientId:`salmon`,position:new V(p,1.3525,-1.44),cols:3,rows:2}],plateSpot:new V(-1.32,.92,-3.66+Y.back),sinkStation:i.userData.sinkStation,sinkSpot:i.userData.sinkStation.position.clone().setZ(i.userData.sinkStation.position.z+Y.back),fridge:{pivot:n.userData.doorPivot,hitbox:n.userData.doorHitbox,area:n.userData.doorArea,updateArea:()=>hu(n.userData.doorArea,n.userData.doorPivot),openAngle:-1.5,unit:n},chopStation:r.userData.chopStation,cookStation:{position:new V(-.2,.95,-3.6),hitboxLeft:t.userData.hitboxLeft,hitboxRight:t.userData.hitboxRight,panLeft:t.userData.panLeft,panRight:t.userData.panRight,flameLeft:t.userData.flameLeft,flameRight:t.userData.flameRight,flameLightLeft:t.userData.flameLightLeft,flameLightRight:t.userData.flameLightRight,foodSpotLeft:new V(-.6,1.01,-3.66+Y.back),foodSpotRight:new V(.2,1.01,-3.66+Y.back)},bounds:Ol,obstacles:nu(),spawn:{position:new V(-.9,1.62,1.2),yaw:-.99}}}var Cu=.78,wu={x:1,z:2.7},Tu=q(11564607,{roughness:.78}),Eu=q(9264176,{roughness:.82}),Du=q(14930870,{roughness:.95});function Ou(e,t,n){let r=new U;return r.add(J(.42,.06,.42,Tu,[0,.44,0])),r.add(J(.42,.5,.06,Tu,[0,.72,-.19])),[[-.17,-.17],[.17,-.17],[-.17,.17],[.17,.17]].forEach(e=>{r.add(J(.05,.44,.05,Eu,[e[0],.22,e[1]]))}),r.add(J(.38,.04,.3,Du,[0,.49,0])),r.position.set(e,0,t),r.rotation.y=n,r}function ku(){let e=new U,t=wu.x,n=wu.z;e.add(J(2.2,.08,1,Tu,[t,Cu-.04,n])),e.add(J(2.02,.07,.84,Eu,[t,.665,n])),[t-.96,t+.96].forEach(t=>{[n-.4,n+.4].forEach(n=>{e.add(J(.09,.7,.09,Eu,[t,.35,n]))})}),e.add(Ou(t-.65,n-.92,0)),e.add(Ou(t+.65,n-.92,0)),e.add(Ou(t-1.42,n,Math.PI/2)),e.add(Ou(t+1.42,n,-Math.PI/2));let r=[-.75,-.25,.25,.75].map(e=>new V(t+e,Cu,n)),i=new Zr(new Ci(2.2,.006,1),new zr({transparent:!0,opacity:0,depthWrite:!1}));return i.position.set(t,.784,n),e.add(i),{root:e,slots:r,hitbox:i,obstacles:[{minX:t-1.45,maxX:t+1.45,minZ:n-1.2,maxZ:n+.58}]}}var Au=[{id:`tomato_egg`,name:`番茄炒蛋`,emoji:`🍳`,ingredients:[`tomato`,`egg`],desc:`酸甜裹着蛋香，最家常也最难失手的一道菜。`},{id:`veg_salad`,name:`时蔬沙拉`,emoji:`🥗`,ingredients:[`tomato`,`cabbage`,`carrot`],desc:`把三种蔬菜的清脆叠在一起，淋一点油醋汁。`},{id:`mushroom_beef`,name:`蘑菇煎牛肉`,emoji:`🥘`,ingredients:[`beef`,`mushroom`],desc:`牛肉煎到焦边，蘑菇吸满了锅里的肉汁。`},{id:`potato_soup`,name:`土豆浓汤`,emoji:`🍲`,ingredients:[`potato`,`carrot`],desc:`熬到绵软的土豆与胡萝卜，暖胃又温柔。`},{id:`salmon_potato`,name:`香煎三文鱼配土豆`,emoji:`🍽️`,ingredients:[`salmon`,`potato`],desc:`外皮微脆的三文鱼，配一勺绵密土豆泥。`},{id:`garden_stew`,name:`田园炖菜`,emoji:`🥣`,ingredients:[`potato`,`mushroom`,`cabbage`],desc:`慢火炖出的田园气息，简单却让人安心。`}],ju=new Map(Au.map(e=>[e.id,e]));function Mu(e){return ju.get(e)}function Nu(e){let t=Pu(e);return t&&Au.find(e=>Pu(e.ingredients)===t)||null}function Pu(e){return!e||e.length===0?``:[...e].sort().join(`+`)}var Fu=1.08,Iu=.74;function Lu(){let e=new U,t=document.createElement(`canvas`);t.width=540,t.height=370;let n=new yi(t);n.colorSpace=Be,n.anisotropy=4,e.add(J(1.1700000000000002,.83,.05,q(9264176,{roughness:.78}),[0,0,0])),e.add(J(1.11,.77,.06,q(11564607,{roughness:.82}),[0,0,.005]));let r=new Zr(new Ai(Fu,Iu),new zr({map:n}));r.position.z=.04,e.add(r),e.add(J(.05,.05,.05,q(2894896,{roughness:.6}),[0,.43,0]));let i=t.getContext(`2d`);function a(e,t,n,r,a){i.beginPath(),i.moveTo(e+a,t),i.lineTo(e+n-a,t),i.quadraticCurveTo(e+n,t,e+n,t+a),i.lineTo(e+n,t+r-a),i.quadraticCurveTo(e+n,t+r,e+n-a,t+r),i.lineTo(e+a,t+r),i.quadraticCurveTo(e,t+r,e,t+r-a),i.lineTo(e,t+a),i.quadraticCurveTo(e,t,e+a,t),i.closePath()}function o(e,r,o=1){i.fillStyle=`#3b2c1e`,i.fillRect(0,0,t.width,t.height),i.fillStyle=`#6b4a2c`;for(let e=0;e<46;e+=1)i.fillRect(0,e*8+2,t.width,1);i.fillStyle=`#ffe0b3`,i.font=`bold 40px "Microsoft YaHei", "PingFang SC", sans-serif`,i.textAlign=`center`,i.fillText(`今日菜单`,t.width/2,62),i.fillStyle=`rgba(255, 224, 179, 0.4)`,i.fillRect(48,82,t.width-96,2),i.fillStyle=`#ffb672`,i.font=`bold 25px "Microsoft YaHei", "PingFang SC", sans-serif`,i.textAlign=`right`,i.fillText(`第 `+o+` 天`,t.width-48,60),i.textAlign=`center`;let s=(e.length>0?e:[]).filter(e=>Mu(e)!==void 0);s.forEach((e,n)=>{let o=Mu(e),s=104+n*86,c=r.includes(e);i.fillStyle=c?`rgba(120, 200, 130, 0.22)`:`rgba(255, 255, 255, 0.07)`,a(40,s,t.width-80,72,16),i.fill(),i.textAlign=`left`,i.font=`38px "Microsoft YaHei", "PingFang SC", sans-serif`,i.fillText(o.emoji,62,s+50),i.fillStyle=c?`#c9f0c9`:`#ffe9cf`,i.font=`bold 32px "Microsoft YaHei", "PingFang SC", sans-serif`,i.fillText(o.name,122,s+48),i.textAlign=`right`,i.font=`bold 38px "Microsoft YaHei", "PingFang SC", sans-serif`,i.fillStyle=c?`#7fd48a`:`rgba(255, 233, 207, 0.45)`,i.fillText(c?`✓`:`○`,t.width-62,s+49),i.textAlign=`left`,i.fillStyle=`#ffe9cf`});let c=s.filter(e=>r.includes(e)).length;i.textAlign=`center`,i.font=`24px "Microsoft YaHei", "PingFang SC", sans-serif`,i.fillStyle=`rgba(255, 224, 179, 0.72)`,i.fillText(s.length>0?c+` / `+s.length+` 已完成`:`等待开门营业`,t.width/2,t.height-22),n.needsUpdate=!0}return o([],[],1),{root:e,draw:o}}var Ru=[{id:`tomato`,name:`番茄`,emoji:`🍅`,color:`#e0463a`,needsChopping:!0},{id:`egg`,name:`鸡蛋`,emoji:`🥚`,color:`#f2e2c4`,needsChopping:!1},{id:`potato`,name:`土豆`,emoji:`🥔`,color:`#c69a5c`,needsChopping:!0},{id:`carrot`,name:`胡萝卜`,emoji:`🥕`,color:`#e8823a`,needsChopping:!0},{id:`cabbage`,name:`卷心菜`,emoji:`🥬`,color:`#7fbf5a`,needsChopping:!0},{id:`mushroom`,name:`蘑菇`,emoji:`🍄`,color:`#c9a98a`,needsChopping:!0},{id:`beef`,name:`牛肉`,emoji:`🥩`,color:`#b4453c`,needsChopping:!0},{id:`salmon`,name:`三文鱼`,emoji:`🐟`,color:`#f08a5d`,needsChopping:!0}],zu=new Map(Ru.map(e=>[e.id,e]));function Bu(e){return zu.get(e)}function Vu(e){let t=zu.get(e);return!!(t&&t.needsChopping)}var Hu={flatShading:!0},Uu=6261306,Wu=9069112;function Gu(e,t,n,r,i=.0035){let a=new U;for(let o=0;o<e;o+=1){let s=new U;s.rotation.y=o*Math.PI*2/e,s.add(J(t,i,t*.42,q(n,Hu),[t*.55,r,0])),a.add(s)}return a}function Ku(e,t,n,r,i=1){let a=Ot.degToRad(n),o=Ot.degToRad(r);return[e[0]+t[0]*i*Math.sin(a)*Math.cos(o),e[1]+t[1]*i*Math.cos(a),e[2]+t[2]*i*Math.sin(a)*Math.sin(o)]}function qu(e,t,n,r){return gl(e,e,t,n,r,[-Math.PI/2,0,Math.PI/2],3)}var Ju={tomato(){let e=_l(.035,q(14698042,Hu),[0,.032,0],12);return e.scale.set(1,.9,1),Cl([e,gl(.0035,.005,.014,q(Uu,Hu),[0,.063,0],null,6),Gu(5,.021,Uu,.06)])},egg(){let e=_l(.022,q(16247247,{flatShading:!0,roughness:.55}),[0,.029,0],12);return e.scale.set(1,1.32,1),e.rotation.z=.1,Cl([e])},potato(){let e=[0,.036,0],t=[.05,.036,.041],n=_l(.05,q(13015644,Hu),e,12);n.scale.set(1,.72,.82);let r=[[58,18],[74,140],[102,250],[44,300],[116,58]].map(([n,r])=>{let i=_l(.006,q(Wu,Hu),Ku(e,t,n,r,.97),6);return i.scale.set(1,.55,1),i}),i=[[38,95],[128,210]].map(([n,r])=>_l(.013,q(13015644,Hu),Ku(e,t,n,r,.86),6));return Cl([n,...r,...i])},carrot(){return Cl([gl(.012,.0022,.15,q(15237690,Hu),[0,.012,0],[0,0,Math.PI/2],10),bl(.0055,.05,q(Uu,Hu),[-.101,.019,-.008],[0,.3,Math.PI/2+.4],5),bl(.0055,.06,q(Uu,Hu),[-.104,.019,.001],[0,.05,Math.PI/2+.12],5),bl(.0055,.045,q(Uu,Hu),[-.099,.018,.009],[0,-.25,Math.PI/2+.5],5)])},cabbage(){let e=_l(.062,q(11064442,Hu),[0,.058,0],12);return e.scale.set(1,.82,1),Cl([e,...[0,1,2,3].map(e=>{let t=e*Math.PI/2,n=_l(.066,q(e%2?8372058:6990152,Hu),[Math.cos(t)*.02,.05,Math.sin(t)*.02],9);return n.scale.set(1,.66,1),n})])},mushroom(){let e=gl(.008,.011,.032,q(15720648,Hu),[0,.016,0],null,10),t=vl(.026,q(11569763,Hu),[0,.03,0],10);return t.scale.set(1,.78,1),Cl([e,t,...[[-.012,.045,.007],[.011,.043,-.009],[.001,.048,.014]].map(e=>{let t=_l(.0045,q(15127480,Hu),e,6);return t.scale.set(1,.45,1),t})])},beef(){return Cl([J(.155,.028,.115,q(11814204,Hu),[0,.015,0]),J(.152,.03,.014,q(15720655,Hu),[0,.016,-.058]),...[-.028,0,.028].map((e,t)=>J(.125-t*.015,.004,.009,q(14256774,Hu),[t*.006,.0275,e]))])},salmon(){let e=new U,t=qu(.03,.145,q(15764061,Hu),[0,.015,0]),n=J(.145,.005,.05,q(9276822,Hu),[0,.0025,0]),r=[[-.01,.0277],[.002,.0415],[.012,.0243]].map(([e,t],n)=>J(.128-n*.012,.005,.007,q(16305074,Hu),[n*.004,t,e]));return e.add(t,n,...r),e.scale.set(1,.72,1.5),e}},Yu={tomato:`wedges`,potato:`cubes`,carrot:`slices`,cabbage:`strips`,mushroom:`slices`,beef:`cubes`,salmon:`cubes`,egg:`cubes`},Xu={slices:.005,strips:.0062,wedges:.006,cubes:.0125},Zu=[[-.014,.01,.4,0],[.013,-.011,1.1,0],[.015,.013,.2,0],[-.016,-.012,.9,0],[.001,.002,1.6,1],[-.009,-.014,.6,1],[.012,.011,1.3,2]];function Qu(e,t=0){let n=Bu(e),r=new W(n?n.color:`#cccccc`),i=r.clone().lerp(new W(16777215),.32).getHex(),a=q(t%2?i:r.getHex(),Hu),o=Yu[e]||`cubes`;if(o===`slices`)return gl(.0155,.0155,.0045,a,[0,.0022,0],null,10);if(o===`strips`)return J(.038,.006,.008,a,[0,.003,0]);if(o===`wedges`){let e=new U;return e.add(qu(.011,.017,a,[0,.0055,0])),e}return J(.0135,.013,.0135,a,[0,.0065,0])}function $u(e){let t=Xu[Yu[e]]||Xu.cubes;return Cl(Zu.map((n,r)=>{let[i,a,o,s]=n,c=Qu(e,r);return c.position.set(i,s*t,a),c.rotation.y=o,c}))}function ed(e,t=!1){let n=Ju[e],r=t?$u(e):n?n():Cl([_l(.035,q(13421772,Hu),[0,.035,0],10)]);return r.userData.ingredientId=e,r.userData.chopped=t,El(r)}function td(e,t){let n=ed(e),r=Tl(n),i=new Yn().setFromObject(n).getSize(new V),a=Math.max(1,t.cols),o=Math.max(1,t.rows),s=a*o,c=Math.max(i.z*1.06,.05),l=Math.max(i.x*1.06,.05),u=t.yaw||0,d=new U,f=new Qt,p=new kt,m=new V,h=new V(1,1,1),g=new ln;return r.forEach(e=>{let t=new li(e.geometry,e.material,s);for(let e=0;e<s;e+=1){let n=e%a,r=Math.floor(e/a);m.set((r-(o-1)/2)*l,0,(n-(a-1)/2)*c+(r%2?c*.5:0)),g.set(0,u,0),p.setFromEuler(g),f.compose(m,p,h),t.setMatrixAt(e,f)}t.instanceMatrix.needsUpdate=!0,t.castShadow=!0,t.receiveShadow=!0,d.add(t)}),d.userData.unitSize=i,d.userData.capacity=s,El(d)}var nd=24,rd=.016,id=.0156,ad=[[0,.006],[.049,.006],[.056,.0037],[.06,0],[.075,0],[.079,.0027],[.083,.006],[.11,.0065],[.119,.0084],[.129,.0156],[.135,.0213],[.135,.0229],[.133,.0238],[.121,.0238],[.114,.0221],[.11,.0195],[.107,.0172]],od=[[.107,.0172],[.094,.0162],[.071,.0157],[.04,.0156],[0,.0156]];function sd(e){return new Oi(e.map(e=>new B(e[0],e[1])),nd)}var cd=sd(ad),ld=sd(od);function ud(e,t){let n=new Zr(e,t);return n.castShadow=!0,n.receiveShadow=!0,n}var dd=q(16249834,{roughness:.34}),fd=q(15525336,{roughness:.42}),pd=q(10124114,{flatShading:!0,roughness:.9});function md(){return[ud(cd,dd),ud(ld,fd)]}var hd=.02,gd=.062,_d=[[0,.004],[.038,.004],[.048,0],[.053,.006],[.058,.018],[.075,.048],[.086,.07],[.09,.078],[.086,.08],[.082,.074],[.07,.048],[.058,.028],[.05,.022]],vd=[[.05,.022],[.028,.0205],[0,.02]],yd=sd(_d),bd=sd(vd);function xd(){return[ud(yd,dd),ud(bd,fd)]}function Sd(e,t,n){return t.map((t,r)=>{let i=Qu(e,r);return i.position.set(t[0],n+t[1],t[2]),i.rotation.y=t[3],i})}var Cd={tomato_egg(){let e=[[-.028,.013,-.012,.4],[.02,.015,.022,1.2],[.042,.013,-.004,2.1],[-.002,.031,.006,.8],[.02,.043,-.014,1.7]].map(([e,t,n,r])=>{let i=yl(.018,q(15909198,{flatShading:!0}),[e,t,n]);return i.scale.set(1,.72,.95),i.rotation.y=r,i});return[...Sd(`tomato`,[[-.042,0,.016,.5],[.034,0,-.018,1.2],[.004,0,.036,.2],[-.014,.017,-.01,.9]],0),...e]},veg_salad(){return[...xd(),...Sd(`cabbage`,[[-.03,.002,.022,.4],[.03,.002,-.014,1.1],[.002,.002,.032,.8],[-.036,.012,-.02,.2],[.022,.014,.018,1.5],[.004,.026,-.006,.6]],hd),...Sd(`carrot`,[[-.02,.004,-.028,.3],[.032,.006,.024,1],[0,.028,.014,1.7]],hd),...Sd(`tomato`,[[-.03,.016,.01,.7],[.026,.03,-.006,1.3],[.006,.04,.012,.1]],hd)]},mushroom_beef(){let e=ed(`beef`);return e.position.set(0,0,-.024),e.rotation.y=.12,[e,...Sd(`mushroom`,[[-.046,0,.074,.3],[0,0,.08,.9],[.046,0,.07,1.5],[-.02,.0055,.052,.5],[.03,.0055,.048,1.2]],0)]},potato_soup(){return[...xd(),gl(.0755,.0755,.006,q(15983284,{roughness:.3}),[0,gd,0],null,22),...[[-.032,.02,.4],[.028,-.018,1.2],[.006,.036,2.2]].map(([e,t,n])=>{let r=yl(.009,q(15257754,{flatShading:!0}),[e,.069,t]);return r.scale.set(1.1,.5,1.1),r.rotation.y=n,r})]},salmon_potato(){let e=ed(`salmon`);return e.position.set(-.004,0,-.02),[e,...[[-.05,.046],[.048,.049]].map(([e,t],n)=>{let r=_l(.022,q(16116436,{flatShading:!0}),[e,.017,t],10);return r.scale.set(1,.78,.95),r.rotation.y=n*.9,r})]},garden_stew(){return[...xd(),gl(.075,.075,.006,q(14198890,{roughness:.35}),[0,gd,0],null,22),...Sd(`potato`,[[-.024,.004,.02,.5],[.03,.004,-.012,1.3],[0,.016,.028,.9]],gd),...Sd(`mushroom`,[[-.032,.006,-.014,.4],[.02,.008,.026,1.6]],gd),...Sd(`cabbage`,[[.006,.012,-.026,1.1],[-.01,.024,.004,.3]],gd)]}};function wd(e){let t=new U,n=Cd[e];return n&&n().forEach(e=>t.add(e)),t}function Td(e,t){if(e.children.length===0)return;e.position.y=0,e.updateWorldMatrix(!1,!0);let n=new Yn().setFromObject(e);e.position.y=t-n.min.y}var Ed=[[-.044,.024],[.024,-.036],[.044,.04],[-.016,-.04]],Dd=[-.0016,.0016,-.0032,0];function Od(e=!1){let t=Cl(md());return e&&Ed.forEach((e,n)=>{let r=yl(.026,pd,[e[0],id+Dd[n],e[1]]);r.scale.set(1.5,.22,1.1),t.add(r)}),t.userData.dirty=e,El(t)}function kd(e){let t=Cl();if(e<=0)return t;let n=[],r=[];for(let t=0;t<e;t+=1){let e=t*rd;n.push(cd.clone().translate(0,e,0)),r.push(ld.clone().translate(0,e,0))}let i=wl(n,dd);i.castShadow=!0;let a=wl(r,fd);return a.castShadow=!0,t.add(i,a),t}function Ad(e){let t=wd(e);return Td(t,0),t.userData.recipeId=e,El(t)}function jd(e){let t=Cl(md()),n=wd(e);return Td(n,id),t.add(n),t.userData.recipeId=e,El(t)}var Md=[{level:1,exp:0,unlock:[`tomato_egg`,`veg_salad`],title:`开张营业`},{level:2,exp:40,unlock:[`potato_soup`],title:`暖汤上桌`},{level:3,exp:110,unlock:[`mushroom_beef`],title:`火候渐稳`},{level:4,exp:200,unlock:[`garden_stew`],title:`田园风味`},{level:5,exp:300,unlock:[`salmon_potato`],title:`压轴主菜`}],Nd={cook:12,hotPlate:6,eat:10,wash:4,firstTime:8,daily:22,dailyAll:30},Pd=Md.length;function Fd(e){return Md[Math.min(Math.max(e,1),Pd)-1]}function Id(e){let t=1;return Md.forEach(n=>{e>=n.exp&&(t=n.level)}),t}function Ld(e){return Fd(e).exp}function Rd(e){return e>=Pd?Fd(Pd).exp:Fd(e+1).exp}function zd(e){let t=new Set;return Md.forEach(n=>{n.level<=e&&n.unlock.forEach(e=>t.add(e))}),t}function Bd(e){let t=Md.find(t=>t.unlock.includes(e));return t?t.level:1}var Vd=1.62,Hd=.95,Ud=.45,Wd=9,Gd=1.35,Kd=.003,qd=.0023,Jd=.006,Yd=2.6,Xd=.3,Zd=1.4;function Qd(e,t,n){let r={yaw:0,pitch:0},i={id:null,x:0,y:0},a={id:null,x:0,y:0},o=new Set,s=new Set,c=new Set,l=[],u=null,d=0,f=!1,p=Vd,m=typeof t.requestPointerLock==`function`,h=0;e.rotation.order=`YXZ`;function g(){e.rotation.y=r.yaw,e.rotation.x=r.pitch}function _(){e.position.x=Ot.clamp(e.position.x,n.minX,n.maxX),e.position.z=Ot.clamp(e.position.z,n.minZ,n.maxZ),e.position.y=p}function v(){let t=e.position;l.forEach(e=>{let r=e.minX-Xd,i=e.maxX+Xd,a=e.minZ-Xd,o=e.maxZ+Xd;if(t.x<=r||t.x>=i||t.z<=a||t.z>=o)return;let s=null,c=1/0,l=(e,r)=>{if(e<n.minX||e>n.maxX||r<n.minZ||r>n.maxZ)return;let i=Math.abs(e-t.x)+Math.abs(r-t.z);i<c&&(c=i,s={x:e,z:r})};l(r,t.z),l(i,t.z),l(t.x,a),l(t.x,o),s&&(t.x=s.x,t.z=s.z)})}let y=new V,b=new V;function x(){return y.set(-Math.sin(r.yaw),0,-Math.cos(r.yaw))}function S(){return b.set(Math.cos(r.yaw),0,-Math.sin(r.yaw))}function C(t,n){t!==0&&e.position.addScaledVector(x(),t),n!==0&&e.position.addScaledVector(S(),n),d+=Math.abs(t)+Math.abs(n),_(),v()}function w(e){C(e,0)}function T(e){C(0,e)}function E(e,t){e===0&&t===0||(r.yaw-=e*qd,r.pitch=Ot.clamp(r.pitch-t*qd,-1.35,Gd),g())}function D(){return document.pointerLockElement===t}function ee(){h=performance.now()+Zd*1e3,c.forEach(e=>e(!1))}function te(){o.clear(),i.id=null,a.id=null,u=null}function O(){if(!m||D()||performance.now()<h)return;let e=t.requestPointerLock();e&&typeof e.catch==`function`&&e.catch(ee)}function ne(){D()&&document.exitPointerLock()}function k(e){return c.add(e),()=>c.delete(e)}document.addEventListener(`pointerlockchange`,()=>{let e=D();e?h=0:te(),c.forEach(t=>t(e))}),t.addEventListener(`pointerlockerror`,ee);function A(e){if(!(e.pointerType===`mouse`&&e.button!==0)){if(t.setPointerCapture&&!D())try{t.setPointerCapture(e.pointerId)}catch{u=null}if(e.pointerType===`touch`&&i.id!==null){a.id=e.pointerId,a.x=e.clientX,a.y=e.clientY,u=null;return}e.pointerType===`touch`&&i.id===null&&(i.id=e.pointerId,i.x=e.clientX,i.y=e.clientY),u={id:e.pointerId,x:e.clientX,y:e.clientY,time:performance.now()}}}function re(e){if(e.pointerType===`touch`){if(e.pointerId===i.id){let t=e.clientX-i.x,n=e.clientY-i.y;i.x=e.clientX,i.y=e.clientY,r.yaw-=t*Kd,r.pitch=Ot.clamp(r.pitch-n*Kd,-1.35,Gd),g(),u&&Math.hypot(e.clientX-u.x,e.clientY-u.y)>8&&(u=null);return}if(e.pointerId===a.id){let t=e.clientX-a.x,n=e.clientY-a.y;a.x=e.clientX,a.y=e.clientY,w(-n*Jd),T(t*Jd)}return}E(e.movementX||0,e.movementY||0),!D()&&u&&Math.hypot(e.clientX-u.x,e.clientY-u.y)>8&&(u=null)}function ie(e){e.pointerId===i.id&&(i.id=null),e.pointerId===a.id&&(a.id=null),u&&u.id===e.pointerId&&performance.now()-u.time<260&&s.forEach(e=>e()),u=null}function j(e){if(e.code===`ControlLeft`||e.code===`ControlRight`){e.repeat||(f=!f);return}o.add(e.code)}function ae(e){o.delete(e.code)}t.addEventListener(`pointerdown`,A),t.addEventListener(`pointermove`,re),t.addEventListener(`pointerup`,ie),t.addEventListener(`pointercancel`,ie),t.addEventListener(`contextmenu`,e=>e.preventDefault()),window.addEventListener(`keydown`,j),window.addEventListener(`keyup`,ae),window.addEventListener(`blur`,te),document.addEventListener(`visibilitychange`,te);function oe(t){d=0;let n=f?Hd:Vd;Math.abs(p-n)>5e-4&&(p+=(n-p)*Math.min(t*Wd,1),e.position.y=p);let r=0,i=0;if((o.has(`KeyW`)||o.has(`ArrowUp`))&&(r+=1),(o.has(`KeyS`)||o.has(`ArrowDown`))&&--r,(o.has(`KeyD`)||o.has(`ArrowRight`))&&(i+=1),(o.has(`KeyA`)||o.has(`ArrowLeft`))&&--i,r!==0||i!==0){let e=Yd*(f?Ud:1)*t;C(r*e,i*e)}return d}function se(e){l=e||[],v()}function ce(t,n,i=0){e.position.copy(t),r.yaw=n,r.pitch=Ot.clamp(i,-1.35,Gd),g(),_(),v()}function le(){return f=!f,f}function ue(){return f}function de(e){return s.add(e),()=>s.delete(e)}return{update:oe,resolve:v,setObstacles:se,setView:ce,onTap:de,requestLock:O,releaseLock:ne,isLocked:D,onLockChange:k,toggleCrouch:le,isCrouched:ue}}function $d(e,t=3.6){let n=new Ha,r=new B(0,0),i=[],a=null,o=[];function s(e,t){return e.userData.pick=t,i.includes(e)||i.push(e),e}function c(e){i=i.filter(t=>t!==e),a&&a.object===e&&(Dl(e,!1),a=null)}function l(){n.setFromCamera(r,e),o.length=0,n.intersectObjects(i,!0,o);let s=null,c=null,l=0,u=0;for(let e=0;e<o.length;e+=1){let n=o[e];if(n.distance>t)break;let r=n.object;for(;r&&!r.userData.pick;)r=r.parent;if(!r)continue;let i=r.userData.pick,a=i.priority||1;if((!s||a>u)&&(s=r,c=i,l=n.distance,u=a,a>=2))break}return a&&(!s||s!==a.object)&&(Dl(a.object,!1),a=null),s&&(!a||a.object!==s)&&(Dl(s,!0),a={object:s,data:c,distance:l,priority:u}),a}return{register:s,unregister:c,detect:l,getHovered:()=>a,targetCount:()=>i.length}}var ef=[];function tf(e){return 1-(1-e)**3}function nf({duration:e=.3,delay:t=0,ease:n=tf,onUpdate:r,onDone:i}){let a={time:-t,duration:Math.max(e,1e-4),ease:n,onUpdate:r,onDone:i};return ef.push(a),a}function rf(e){for(let t=ef.length-1;t>=0;--t){let n=ef[t];if(n.time+=e,n.time<0)continue;let r=Math.min(n.time/n.duration,1);n.onUpdate&&n.onUpdate(n.ease(r),r),r>=1&&(ef.splice(t,1),n.onDone&&n.onDone())}}function af(){return ef.length}function of(e,t,n,{duration:r=.4,ease:i=tf,onUpdate:a,onDone:o}){let s=e.clone(),c=t.clone(),l=s.clone().lerp(c,.5);return l.y+=n,nf({duration:r,ease:i,onUpdate:(e,t)=>{let n=s.clone().lerp(l,e),r=l.clone().lerp(c,e);a&&a(n.lerp(r,e),t)},onDone:o})}var sf=null,cf=null,lf=null,uf=!1,df=.42;function ff(){if(sf)return sf;let e=window.AudioContext||window.webkitAudioContext;if(!e)return null;sf=new e,cf=sf.createGain(),cf.gain.value=uf?0:df,cf.connect(sf.destination);let t=Math.floor(sf.sampleRate*.6);lf=sf.createBuffer(1,t,sf.sampleRate);let n=lf.getChannelData(0);for(let e=0;e<t;e+=1)n[e]=Math.random()*2-1;return sf}function pf(){let e=ff();e&&e.state===`suspended`&&e.resume()}function mf(){return uf=!uf,cf&&(cf.gain.value=uf?0:df),uf}function hf(){return uf}function gf({freq:e,to:t,type:n=`sine`,duration:r=.18,volume:i=.18,delay:a=0,attack:o=.012}){let s=ff();if(!s||uf)return;let c=s.currentTime+a,l=s.createOscillator(),u=s.createGain();l.type=n,l.frequency.setValueAtTime(e,c),t&&l.frequency.exponentialRampToValueAtTime(Math.max(t,1),c+r),u.gain.setValueAtTime(1e-4,c),u.gain.linearRampToValueAtTime(i,c+o),u.gain.exponentialRampToValueAtTime(1e-4,c+r),l.connect(u),u.connect(cf),l.start(c),l.stop(c+r+.03)}function _f({duration:e=.2,volume:t=.2,freq:n=1400,q:r=.8,delay:i=0,sweepTo:a,type:o=`bandpass`}){let s=ff();if(!s||uf)return;let c=s.currentTime+i,l=s.createBufferSource();l.buffer=lf;let u=s.createBiquadFilter();u.type=o,u.frequency.setValueAtTime(n,c),u.Q.value=r,a&&u.frequency.exponentialRampToValueAtTime(Math.max(a,20),c+e);let d=s.createGain();d.gain.setValueAtTime(1e-4,c),d.gain.linearRampToValueAtTime(t,c+.01),d.gain.exponentialRampToValueAtTime(1e-4,c+e),l.connect(u),u.connect(d),d.connect(cf),l.start(c),l.stop(c+e+.03)}var X={click(){gf({freq:720,to:900,type:`triangle`,duration:.08,volume:.1})},chop(e){_f({duration:.08,volume:.3,freq:2800-e*400,q:.7,sweepTo:900}),gf({freq:420-e*40,to:200,type:`triangle`,duration:.07,volume:.1})},chopped(){_f({duration:.16,volume:.26,freq:2200,q:.6,sweepTo:600}),gf({freq:660,to:990,type:`triangle`,duration:.16,volume:.12})},pick(){gf({freq:880,to:1320,type:`sine`,duration:.12,volume:.12})},plate(){gf({freq:1240,type:`sine`,duration:.2,volume:.14}),gf({freq:1860,type:`sine`,duration:.14,volume:.06,delay:.02})},serve(){gf({freq:520,to:780,type:`triangle`,duration:.22,volume:.13}),gf({freq:1040,type:`sine`,duration:.24,volume:.07,delay:.06})},cook(){_f({duration:.6,volume:.24,freq:600,q:.5,sweepTo:2400}),gf({freq:300,to:520,type:`sawtooth`,duration:.4,volume:.05})},sizzle(){_f({duration:1.7,volume:.09,freq:1500,q:.45,sweepTo:820}),_f({duration:.9,volume:.05,freq:3400,q:1.1,delay:.2,sweepTo:1600})},drop(){_f({duration:.16,volume:.17,freq:1900,q:.7,sweepTo:700}),gf({freq:320,to:175,type:`sine`,duration:.13,volume:.09})},toss(){_f({duration:.34,volume:.2,freq:700,q:.5,sweepTo:2100}),gf({freq:260,to:470,type:`triangle`,duration:.22,volume:.08})},eat(){[0,.14,.28].forEach((e,t)=>{gf({freq:620+t*90,to:460+t*60,type:`triangle`,duration:.12,volume:.1,delay:e})})},eatDone(){[0,.1,.2].forEach((e,t)=>{gf({freq:[784,988,1318][t],type:`sine`,duration:.26,volume:.11,delay:e})})},wash(){_f({duration:1.1,volume:.16,freq:900,q:.4,sweepTo:2600}),_f({duration:.5,volume:.12,freq:3200,q:1.2,delay:.1,sweepTo:1400})},washDone(){gf({freq:1100,to:1650,type:`sine`,duration:.3,volume:.12})},sprite(){gf({freq:1568,type:`sine`,duration:.16,volume:.07})},daily(){[0,.1].forEach((e,t)=>{gf({freq:t===0?988:1318,type:`sine`,duration:.24,volume:.11,delay:e})})},levelUp(){[0,.12,.24,.38].forEach((e,t)=>{gf({freq:[523,659,784,1046][t],type:`triangle`,duration:.42,volume:.13,delay:e})}),gf({freq:261,type:`sine`,duration:.8,volume:.06,delay:.2})},deny(){gf({freq:240,to:170,type:`square`,duration:.14,volume:.07})},step(e=!1,t=!1){let n=e?.028:.048,r=(t?1.12:.94)*(e?.86:1);_f({duration:.075,volume:n*.9,freq:620*r,q:.8,sweepTo:190*r}),gf({freq:150*r,to:58,type:`sine`,duration:.095,volume:n,attack:.004}),gf({freq:320*r,to:140,type:`triangle`,duration:.05,volume:n*.35,attack:.003})}},vf={crumb:()=>new Ci(.024,.024,.024),steam:()=>new ji(.05,6,5),spark:()=>new ki(.022,0),ring:()=>new Mi(.13,.014,6,20)},yf=96,bf=12;function xf(e,t){let n=new U;e.add(n);let r=document.getElementById(`floaters`),i=[],a=[],o=[],s=new Map,c=new Map,l=new V,u=0,d=window.innerWidth,f=window.innerHeight;window.addEventListener(`resize`,()=>{d=window.innerWidth,f=window.innerHeight});function p(e){return s.has(e)||s.set(e,vf[e]()),s.get(e)}function m(e,t,r){let a=c.get(e);a||(a=[],c.set(e,a));let o=null;if(a.length>0)o=a.pop();else if(u<yf){u+=1;let t=new zr({transparent:!0,depthWrite:!1}),r=new Zr(p(e),t);r.visible=!1,n.add(r),o={mesh:r,material:t,pool:e,velocity:new V,gravity:0,life:0,ttl:1,from:1,to:1,opacity:1,spin:0}}else{for(let e of c.values())if(e.length>0){o=e.pop();break}if(!o&&i.length>0&&(o=i.shift()),!o)return null;o.mesh.visible=!1}return o.material.color.setHex(t),o.material.opacity=r,o.mesh.visible=!0,o}function h(e,t,n={}){let{color:r=16777215,count:a=8,speed:o=1.1,spread:s=1,duration:c=.72,gravity:l=4.2,from:u=1,to:d=.35,opacity:f=1,spin:p=6,lift:h=.3,radius:g=0}=n;for(let n=0;n<a;n+=1){let n=m(e,r,f);if(!n)continue;let a=n.mesh;if(a.position.copy(t),g>0){let e=Math.random()*Math.PI*2;a.position.x+=Math.cos(e)*g,a.position.z+=Math.sin(e)*g}a.scale.setScalar(u),n.velocity.set((Math.random()-.5)*s,h+Math.random()*s*.6,(Math.random()-.5)*s).normalize().multiplyScalar(o*(.6+Math.random()*.8)),n.gravity=l*(.7+Math.random()*.6),n.life=0,n.ttl=c*(.75+Math.random()*.5),n.from=u,n.to=d,n.opacity=f,n.spin=p,i.push(n)}}function g(e,t){h(`crumb`,e,{color:t,count:9,speed:1.5,spread:1.1,duration:.62,gravity:6,lift:.5,to:.3})}function _(e,t=6){h(`steam`,e,{color:16777215,count:t,speed:.34,spread:.32,duration:1.5,gravity:-.35,lift:.9,from:.5,to:1.5,opacity:.32,spin:.6,radius:.03})}function v(e,t=16767370,n=7){h(`spark`,e,{color:t,count:n,speed:1.1,spread:1,duration:.5,gravity:2.4,lift:.8,from:1.1,to:.2})}function y(e,t=16761963){h(`ring`,e,{color:t,count:1,speed:.05,spread:.1,duration:.44,gravity:0,lift:0,from:.5,to:2.1,opacity:.75,spin:0})}function b(){return o.length>0?o.pop():{node:document.createElement(`div`),point:new V,life:0,ttl:1.5,rise:.42}}function x(e){e.node.remove(),o.push(e)}function S(e,t,n=``){if(!r)return;a.length>=bf&&x(a.shift());let i=b();i.node.className=n?`floater `+n:`floater`,i.node.textContent=t,i.node.style.opacity=`1`,i.point.copy(e),i.life=0,i.ttl=1.5,i.rise=.42,i.node.parentNode!==r&&r.appendChild(i.node),a.push(i)}function C(e){for(let t=i.length-1;t>=0;--t){let n=i[t];n.life+=e;let r=Math.min(n.life/n.ttl,1);n.velocity.y-=n.gravity*e,n.mesh.position.addScaledVector(n.velocity,e),n.spin!==0&&(n.mesh.rotation.x+=n.spin*e,n.mesh.rotation.y+=n.spin*.6*e),n.mesh.scale.setScalar(n.from+(n.to-n.from)*r),n.material.opacity=n.opacity*(1-r),r>=1&&(n.mesh.visible=!1,n.mesh.scale.setScalar(1),n.mesh.rotation.set(0,0,0),c.get(n.pool).push(n),i.splice(t,1))}for(let n=a.length-1;n>=0;--n){let r=a[n];r.life+=e;let i=Math.min(r.life/r.ttl,1);l.copy(r.point),l.y+=tf(i)*r.rise;let o=l.project(t);if(o.z>1)r.node.style.display=`none`;else{r.node.style.display=`block`;let e=(o.x*.5+.5)*d,t=(-o.y*.5+.5)*f;r.node.style.transform=`translate(-50%, -50%) translate(`+e.toFixed(1)+`px, `+t.toFixed(1)+`px)`,r.node.style.opacity=String(Math.max(0,1-Math.max(0,i-.55)*2.2))}i>=1&&(x(r),a.splice(n,1))}}function w(){i.forEach(e=>{e.mesh.visible=!1,e.mesh.scale.setScalar(1),c.get(e.pool).push(e)}),i.length=0,a.forEach(e=>x(e)),a.length=0}function T(){return{particles:i.length,labels:a.length}}return{crumbs:g,steam:_,spark:v,ring:y,text:S,burst:h,update:C,clear:w,count:T}}function Sf(e){if(e.length===0)return{ok:!1,reason:`empty`};let t=e.filter(e=>!e.chopped&&Vu(e.id));if(t.length>0)return{ok:!1,reason:`unchopped`,pending:t.map(e=>e.id)};let n=Nu(e.map(e=>e.id));return n?{ok:!0,recipe:n}:{ok:!1,reason:`nomatch`}}var Cf=`meishi-wuyu-progress-v1`,wf=2,Tf=5,Z={selected:0,tray:[,,,,,,].fill(null),hand:null,plates:Tf,discovered:new Set,cooked:new Set,eaten:new Set,bonus:new Set,stars:{},exp:0,daily:[],dailyDate:``,dailyDone:[],dailyRound:0,streak:0,bestStreak:0,washed:0,served:0},Ef=new Set;function Df(e){return Ef.add(e),e(Z),()=>Ef.delete(e)}function Of(){Ef.forEach(e=>e(Z))}function kf(){let e=new Date;return e.getFullYear()+`-`+(e.getMonth()+1)+`-`+e.getDate()}function Af(e){let t=7;for(let n=0;n<e.length;n+=1)t=(t*31+e.charCodeAt(n))%2147483647;return t}function jf(e=0){let t=Au.map(e=>e.id).filter(e=>Nf(e));if(t.length<=3)return t;let n=Af(kf()+`#`+e),r=[],i=new Set,a=t.length*4+16;for(;r.length<3&&i.size<t.length&&a>0;){--a,n=Math.imul(n,1103515245)+12345>>>0;let e=n%t.length;i.has(e)||(i.add(e),r.push(t[e]))}for(let e=0;r.length<3&&e<t.length;e+=1)r.includes(t[e])||r.push(t[e]);return r}function Mf(){return Id(Z.exp)}function Nf(e){return Z.bonus.has(e)||zd(Mf()).has(e)}function Pf(){let e=Mf(),t=Ld(e),n=Rd(e),r=Math.max(n-t,1);return{level:e,exp:Z.exp,start:t,end:n,ratio:n>t?Math.min((Z.exp-t)/r,1):1,toNext:Math.max(n-Z.exp,0)}}function Ff(e){if(e<=0)return[];let t=Mf();Z.exp+=e;let n=Mf(),r=[];for(let e=t+1;e<=n;e+=1)r.push(e);return r.length>0&&Bf(),Of(),sp(),r}function If(e,t){return t<=(Z.stars[e]||0)?!1:(Z.stars[e]=Math.min(t,3),Of(),sp(),!0)}function Lf(e){return Z.stars[e]||0}function Rf(){return Z.streak+=1,Z.bestStreak=Math.max(Z.bestStreak,Z.streak),Of(),sp(),Z.streak}function zf(){Z.streak!==0&&(Z.streak=0,Of(),sp())}function Bf(){let e=kf();Z.dailyDate!==e&&(Z.dailyDate=e,Z.dailyDone=[],Z.daily=[]);let t=Z.daily.filter(e=>Nf(e));if(t.length!==Z.daily.length&&(Z.dailyDone=Z.dailyDone.filter(e=>t.includes(e)),Z.daily=t),Z.daily.length<3){let e=jf(Z.dailyRound).filter(e=>!Z.daily.includes(e));Z.daily=Z.daily.concat(e.slice(0,3-Z.daily.length))}Z.dailyDone=Z.dailyDone.filter(e=>Z.daily.includes(e)),sp()}function Vf(){return Z.dailyRound+1}function Hf(){Z.dailyRound+=1,Z.daily=[],Z.dailyDone=[],Bf(),Of(),sp()}function Uf(e){return Z.dailyDone.includes(e)}function Wf(){return Z.daily.length>0&&Z.daily.every(e=>Uf(e))}function Gf(e){return!Z.daily.includes(e)||Uf(e)?!1:(Z.dailyDone.push(e),Of(),sp(),!0)}function Kf(){Z.washed+=1,Of(),sp()}function qf(){Z.served+=1,Of(),sp()}function Jf(){Z.hand=Z.tray[Z.selected]||null}function Yf(e){let t=Math.max(0,Math.min(e,5));return t===Z.selected?!1:(Z.selected=t,Jf(),Of(),!0)}function Xf(){return Z.tray.some(e=>!e)}function Zf(){return Z.tray.filter(Boolean).length}function Qf(e){let t=Z.tray[Z.selected]?Z.tray.findIndex(e=>!e):Z.selected;return t<0?-1:(Z.tray[t]=e,e.kind===`ingredient`&&Z.discovered.add(e.id),Jf(),Of(),sp(),t)}function $f(e){if(e<0||e>=6)return null;let t=Z.tray[e]||null;return Z.tray[e]=null,Jf(),Of(),sp(),t}function ep(e){let t=Z.tray[e];return!t||t.chopped?!1:(t.chopped=!0,Jf(),Of(),sp(),!0)}function tp(e){Z.tray[Z.selected]=e,Jf(),Of(),sp()}function np(){return Z.plates<=0?!1:(--Z.plates,Of(),!0)}function rp(){Z.plates+=1,Of()}function ip(e){Z.cooked.add(e),Of(),sp()}function ap(e){Z.eaten.add(e),Of(),sp()}function op(){return{ingredients:Z.discovered.size,ingredientTotal:Ru.length,recipes:Z.cooked.size,recipeTotal:Au.length,eaten:Z.eaten.size}}function sp(){try{window.localStorage.setItem(Cf,JSON.stringify({version:wf,discovered:[...Z.discovered],cooked:[...Z.cooked],eaten:[...Z.eaten],bonus:[...Z.bonus],stars:Z.stars,exp:Z.exp,daily:Z.daily,dailyDate:Z.dailyDate,dailyDone:Z.dailyDone,dailyRound:Z.dailyRound,streak:Z.streak,bestStreak:Z.bestStreak,washed:Z.washed,served:Z.served}))}catch{return}}function cp(){try{let e=window.localStorage.getItem(Cf);if(!e){Bf();return}let t=JSON.parse(e);Z.discovered=new Set(t.discovered||[]),Z.cooked=new Set(t.cooked||[]),Z.eaten=new Set(t.eaten||[]),Z.stars=t.stars||{},Z.bonus=new Set(t.bonus||[]),Z.daily=(t.daily||[]).filter(e=>Mu(e)!==void 0),Z.dailyDate=t.dailyDate||``,Z.dailyDone=(t.dailyDone||[]).filter(e=>Mu(e)!==void 0),Z.dailyRound=t.dailyRound||0,Z.streak=t.streak||0,Z.bestStreak=t.bestStreak||0,Z.washed=t.washed||0,Z.served=t.served||0,typeof t.exp==`number`?Z.exp=t.exp:(Z.exp=Z.cooked.size*Nd.cook+Z.eaten.size*Nd.eat,Z.cooked.forEach(e=>Z.bonus.add(e))),Bf()}catch{Bf();return}}function lp(){Z.discovered=new Set,Z.cooked=new Set,Z.eaten=new Set,Z.bonus=new Set,Z.stars={},Z.exp=0,Z.daily=[],Z.dailyDone=[],Z.dailyDate=``,Z.dailyRound=0,Z.streak=0,Z.bestStreak=0,Z.washed=0,Z.served=0,Z.tray=[,,,,,,].fill(null),Z.selected=0,Z.hand=null,Z.plates=Tf,Bf(),sp(),Of()}var up=2;function dp(e){let t={root:document.getElementById(`hud`),hint:document.getElementById(`hint`),crosshair:document.getElementById(`crosshair`),stats:document.getElementById(`stats`),toasts:document.getElementById(`toasts`),hand:document.getElementById(`hand`),hotbar:document.getElementById(`hotbar-slots`),hotbarStatus:document.getElementById(`hotbar-status`),level:document.getElementById(`level`),expBar:document.getElementById(`exp-bar`),daily:document.getElementById(`daily`),dailyList:document.getElementById(`daily-list`),dailyTitle:document.getElementById(`daily-title`),action:document.getElementById(`action`),actionLabel:document.getElementById(`action-label`),actionBar:document.getElementById(`action-bar`)};document.getElementById(`btn-gallery`).addEventListener(`click`,e.onOpenGallery),document.getElementById(`btn-menu`).addEventListener(`click`,e.onOpenMenu);let n=[];for(let r=0;r<6;r+=1){let i=document.createElement(`button`);i.className=`hotbar-slot empty`,i.type=`button`;let a=document.createElement(`span`);a.className=`hotbar-key`,a.textContent=String(r+1);let o=document.createElement(`span`);o.className=`hotbar-icon`,i.append(a,o),i.addEventListener(`click`,()=>e.onSelectSlot(r)),t.hotbar.appendChild(i),n.push({button:i,icon:o})}let r=null,i=-1,a=``,o=``;function s(){t.root.classList.remove(`hidden`)}let c=null,l=null,u=null;function d(e,n){c!==e&&(c=e,t.hint.textContent=e);let r=!!e;l!==r&&(l=r,t.hint.classList.toggle(`visible`,r));let i=!!n;u!==i&&(u=i,t.crosshair.classList.toggle(`active`,i))}function f(e){if(!e)return{icon:``,label:`空格子`,cls:`empty`};if(e.kind===`ingredient`){let t=Bu(e.id),n=e.chopped===!0;return{icon:t?t.emoji:`?`,label:(t?t.name:e.id)+(n?`（已切碎）`:Vu(e.id)?`（要切碎）`:``),cls:n?`chopped`:`raw`}}if(e.kind===`plate`)return{icon:`🍽`,label:`干净盘子`,cls:`plate`};if(e.kind===`dirtyPlate`)return{icon:`🍽`,label:`脏盘子`,cls:`dirty`};let t=Mu(e.recipeId);return{icon:t?t.emoji:`🍲`,label:t?t.name:`料理`,cls:`dish`}}function p(e,r=0){let i=0;n.forEach((t,n)=>{let a=e[n]||null,o=f(a);a&&(i+=1);let s=[`hotbar-slot`,o.cls];n===r&&s.push(`selected`),t.button.className=s.join(` `),t.icon.textContent=o.icon,t.button.title=o.label}),t.hotbarStatus&&(t.hotbarStatus.textContent=i===0?`空`:i+`/6`)}function m(e){let t=f(e);return e?t.icon+` `+t.label:`空手`}function h(e){t.hand.textContent=`手上：`+m(e),t.hand.classList.toggle(`holding`,!!e),t.hand.classList.toggle(`dirty`,!!(e&&e.kind===`dirtyPlate`))}function g(){let e=op();t.stats.textContent=`食材 `+e.ingredients+`/`+e.ingredientTotal+` · 料理 `+e.recipes+`/`+e.recipeTotal+` · 已品尝 `+e.eaten}function _(e){let n=e.level+`|`+Math.round(e.ratio*100);n!==a&&(a=n,t.level.textContent=`Lv.`+e.level,t.expBar.style.width=(e.ratio*100).toFixed(1)+`%`,t.level.title=e.end>e.start?`再得 `+e.toNext+` 经验升级`:`已满级，继续做菜也有奖励`,t.expBar.classList.toggle(`full`,e.end<=e.start))}function v(e,n,r,i=1){let a=i+`|`+r+`|`+e.join(`,`)+`|`+n.join(`,`);if(a===o)return;o=a;let s=e.filter(e=>Mu(e)!==void 0);t.dailyList.replaceChildren(...s.map(e=>{let t=Mu(e),r=document.createElement(`div`);r.className=`daily-row`+(n.includes(e)?` done`:``);let i=document.createElement(`span`);i.className=`daily-emoji`,i.textContent=t.emoji;let a=document.createElement(`span`);a.className=`daily-name`,a.textContent=t.name;let o=document.createElement(`span`);return o.className=`daily-check`,o.textContent=n.includes(e)?`✓`:`·`,r.append(i,a,o),r}));let c=s.filter(e=>n.includes(e)).length,l=i>1?`第 `+i+` 天 · `:``;t.dailyTitle.textContent=l+`今日菜单 `+c+`/`+s.length+(r>1?` · 连击 x`+r:``),t.daily.classList.toggle(`all-done`,s.length>0&&c===s.length)}function y({label:e,duration:n,onDone:a}){r={label:e,duration:n,elapsed:0,onDone:a},i=0,t.actionLabel.textContent=e,t.action.classList.remove(`hidden`),t.actionBar.style.transform=`scaleX(0)`}function b(){r&&(r=null,t.action.classList.add(`hidden`))}function x(){return r!==null}function S(e){if(!r)return;r.elapsed+=e;let n=Math.min(r.elapsed/r.duration,1),a=Math.round(n*500)/500;if(a!==i&&(i=a,t.actionBar.style.transform=`scaleX(`+a+`)`),n>=1){let e=r.onDone;r=null,t.action.classList.add(`hidden`),e&&e()}}function C(e){let n=document.createElement(`div`);for(n.className=`toast`,n.textContent=e,t.toasts.appendChild(n);t.toasts.childElementCount>up;)t.toasts.firstElementChild.remove();window.setTimeout(()=>n.classList.add(`out`),2100),window.setTimeout(()=>n.remove(),2700)}return{show:s,setHint:d,updateTray:p,updateHand:h,refreshStats:g,updateProgress:_,updateDaily:v,startAction:y,cancelAction:b,busy:x,tickAction:S,toast:C}}function fp(e){let t=document.getElementById(`menu`),n=document.getElementById(`gallery`),r=document.getElementById(`card`),i=document.getElementById(`card-kicker`),a=document.getElementById(`card-title`),o=document.getElementById(`card-sub`),s=document.getElementById(`card-items`),c=document.getElementById(`gallery-ingredients`),l=document.getElementById(`gallery-recipes`),u=document.getElementById(`gallery-ingredient-count`),d=document.getElementById(`gallery-recipe-count`),f=document.getElementById(`gallery-stats`),p=0;function m(){e.onBlockChange&&e.onBlockChange(w())}document.getElementById(`btn-start`).addEventListener(`click`,()=>{g(),e.onStart()}),document.getElementById(`btn-gallery-menu`).addEventListener(`click`,_),document.getElementById(`btn-reset`).addEventListener(`click`,()=>e.onReset()),document.getElementById(`btn-gallery-close`).addEventListener(`click`,v),document.getElementById(`btn-card-close`).addEventListener(`click`,S);function h(){t.classList.remove(`hidden`),m()}function g(){t.classList.add(`hidden`),m()}function _(){y(),n.classList.remove(`hidden`),m()}function v(){n.classList.add(`hidden`),m()}function y(){let e=Au.reduce((e,t)=>e+Lf(t.id),0);u.textContent=`已收集 `+Z.discovered.size+`/`+Ru.length,d.textContent=`已解锁 `+Au.filter(e=>Nf(e.id)).length+`/`+Au.length+` · 已品尝 `+Z.eaten.size,f.textContent=`Lv.`+Mf()+` · 经验 `+Z.exp+` · 星星 `+e+`/`+Au.length*3+` · 洗过 `+Z.washed+` 个盘子 · 最长连击 `+Z.bestStreak,c.replaceChildren(...Ru.map(e=>{let t=Z.discovered.has(e.id);return b({emoji:t?e.emoji:`❔`,title:t?e.name:`未发现`,lines:t?[e.needsChopping?`需要切碎后才能下锅`:`可以直接下锅`]:[`在冰箱里找找看`],state:t?`owned`:`locked`})})),l.replaceChildren(...Au.map(e=>{let t=Nf(e.id),n=Z.cooked.has(e.id),r=Z.eaten.has(e.id),i=Lf(e.id),a=`★`.repeat(i)+`☆`.repeat(3-i)+` 出餐质量`,o=e.ingredients.map(e=>{let n=Bu(e);return t?n.emoji+n.name:`❔`});return b({emoji:n||t?e.emoji:`❔`,title:t?e.name:`未解锁`,lines:t?[o.join(` + `),n?a:`还没做过`,r?`已品尝 ✔`:e.desc]:[`Lv.`+Bd(e.id)+` 解锁`,`继续做菜累积经验`],state:n?r?`eaten`:`owned`:t?`ready`:`locked`})}))}function b({emoji:e,title:t,lines:n,state:r}){let i=document.createElement(`div`);i.className=`card `+r;let a=document.createElement(`div`);a.className=`card-emoji`,a.textContent=e;let o=document.createElement(`div`);return o.className=`card-title`,o.textContent=t,i.append(a,o),n.forEach(e=>{let t=document.createElement(`p`);t.className=`card-line`,t.textContent=e,i.appendChild(t)}),i}function x({kicker:e,title:t,sub:n,items:c=[],duration:l=2600}){i.textContent=e,a.textContent=t,o.textContent=n,s.replaceChildren(...c.map(e=>{let t=document.createElement(`div`);t.className=`card-item`;let n=document.createElement(`span`);n.className=`card-item-emoji`,n.textContent=e.emoji;let r=document.createElement(`span`);r.className=`card-item-name`,r.textContent=e.name;let i=document.createElement(`span`);return i.className=`card-item-note`,i.textContent=e.note||``,t.append(n,r,i),t})),r.classList.remove(`hidden`),window.clearTimeout(p),p=window.setTimeout(S,l)}function S(){window.clearTimeout(p),r.classList.add(`hidden`)}function C(){return!r.classList.contains(`hidden`)}function w(){return!t.classList.contains(`hidden`)||!n.classList.contains(`hidden`)}return{openMenu:h,openGallery:_,renderGallery:y,showCard:x,closeCard:S,cardOpen:C,isBlocking:w,galleryOpen:()=>!n.classList.contains(`hidden`)}}var pp=3.6,mp=3.6,hp=3,gp=1.7,_p=1.5,vp=28e3,yp=new V(.32,-.24,-.62),bp=.6,xp=.12,Sp=.75,Cp=1.6,wp=1,Tp=.85;function Ep(e){let t=new Yn().setFromObject(e).getSize(new V),n=Math.max(t.x,t.y,t.z);return n>0?Ot.clamp(xp/n,Sp,Cp):1}var Dp=document.getElementById(`game-canvas`),Op=Math.min(window.devicePixelRatio||1,1.5);function kp(){let e=(window.devicePixelRatio||1)<=1.25;try{return new ll({canvas:Dp,antialias:e})}catch{return new ll({canvas:Dp,antialias:!1})}}var Ap=kp();Dp.addEventListener(`webglcontextlost`,()=>{typeof window.showFatal==`function`&&window.showFatal(`显卡上下文丢失，画面会尝试自动恢复；若一直黑屏，请按 Ctrl+Shift+R 强制刷新（多开同一个游戏页面容易触发）。`)}),Ap.setPixelRatio(Op),Ap.setSize(window.innerWidth,window.innerHeight),Ap.shadowMap.enabled=!0,Ap.shadowMap.type=1,Ap.shadowMap.autoUpdate=!1,Ap.shadowMap.needsUpdate=!0,Ap.toneMapping=4,Ap.toneMappingExposure=1.12;var jp=100,Mp=.55,Np=1,Pp=16.7,Fp=16.7,Ip=0,Lp=60,Rp=0,zp=0;function Bp(){Ap.setPixelRatio(Op*Np)}function Vp(e){let t=Math.min(e*1e3,120);if(Pp+=(t-Pp)*.1,Fp=Math.max(4,Math.min(40,Fp+(t-Fp)*(t<Fp?.25:.002))),Lp>0){--Lp,Ip=0;return}Ip=Pp>Fp*1.3?Ip+1:0,Rp-=e,!(Rp>0)&&(Ip>20&&Np>Mp?(Np=Math.max(Mp,Np-.1),Bp(),Rp=.5,Ip=0,Pp=Fp):Pp<Fp*1.03&&Np<1&&(Np=Math.min(1,Np+.08),Bp(),Rp=1.2))}var Hp=new ba(68,window.innerWidth/window.innerHeight,.06,60);Hp.rotation.order=`YXZ`;var Q=Su(),Up=ku();Q.root.add(Up.root);var Wp=Lu();Wp.root.position.set(-3.94+Y.left,1.62,.75),Wp.root.rotation.y=Math.PI/2,Q.root.add(Wp.root);var Gp=new Pn;Gp.background=new W(12575989),Gp.add(Q.root,Hp);var Kp=$d(Hp,pp),qp=Qd(Hp,Dp,Q.bounds),Jp=xf(Gp,Hp),Yp=Up.slots,Xp=Q.cookStation.foodSpotLeft.clone(),Zp=Q.cookStation.foodSpotRight.clone(),Qp=Q.fridge,$p=Q.chopStation,em=$p.knife.position.y,tm={time:-1},nm={key:null,steps:0},rm=new zr({transparent:!0,opacity:0,depthWrite:!1}),im=!1,am=new U;am.position.copy(yp),am.rotation.x=.38,Hp.add(am);var om={punch:0,bob:0,sway:0},sm=null,cm=``,lm=new U;lm.position.copy(Q.plateSpot),Q.root.add(lm);var um=new Zr(new Ci(.34,.26,.34),rm);um.position.set(Q.plateSpot.x,Q.plateSpot.y+.13,Q.plateSpot.z),Q.root.add(um);var dm=Q.ingredientSpots.map((e,t)=>{let n=e.cols*e.rows,r=td(e.ingredientId,{cols:e.cols,rows:e.rows});return r.position.copy(e.position),Q.root.add(r),Kp.register(r,{kind:`ingredient`,spotIndex:t}),{spot:e,pile:r,capacity:n,count:n,refillStep:Math.max(700,7e3/n),readyAt:0}});function fm(e){e.pile.children.forEach(t=>{t.isInstancedMesh&&(t.count=e.count)})}var pm=[],mm=1,hm=-1,gm=``,_m=document.getElementById(`lock-tip`),vm=window.matchMedia(`(hover: none)`).matches,ym=!1,bm=!1;function xm(){let e=ym&&bm&&!qp.isLocked()&&!vm;_m.classList.toggle(`hidden`,!e)}function Sm(){wm.openGallery()}function Cm(){wm.openMenu()}var $=dp({onSelectSlot:e=>Yf(e),onOpenGallery:()=>Sm(),onOpenMenu:()=>Cm()}),wm=fp({onStart:()=>{ym=!0,$.show(),Zh(),qp.requestLock(),xm(),$.toast(`先打开冰箱拿食材，做完菜记得用空盘子装盘`)},onBlockChange:e=>{e?qp.releaseLock():ym&&qp.requestLock(),xm()},onReset:()=>{lp(),pm.slice().forEach(e=>jm(e)),im=!1,Qp.pivot.rotation.y=0,Qp.updateArea(),uh[0].time=-1,uh[0].recipe=null,uh[1].time=-1,uh[1].recipe=null,$.cancelAction(),Jp.clear(),Rm(!1),nm.key=null,nm.steps=0,hh(0),hh(1),wm.renderGallery(),$.toast(`进度已重置，重新开始吧`)}});function Tm(e,t){return e===`food`?Ad(t):e===`dirty`?Od(!0):jd(t)}function Em(e,t){return e===`pan`?t%2==0?Xp:Zp:Yp[t]}function Dm(e){if(e===`pan`){let e=pm.some(e=>e.place===`pan`&&e.slot<=0),t=pm.some(e=>e.place===`pan`&&e.slot>0);return e?t?-1:1:0}let t=pm.filter(t=>t.place===e).map(e=>e.slot);for(let e=0;e<Yp.length;e+=1)if(!t.includes(e))return e;return-1}function Om(){return am.getWorldPosition(new V)}function km(e){return e.node.position.clone().setY(e.node.position.y+.08)}function Am(e,t,n,r,i={}){let a=Tm(e,t),o=Em(n,r).clone(),s={id:mm,kind:e,recipeId:t,place:n,slot:r,node:a,hot:!!i.hot,flying:!!i.fly,bornAt:performance.now()};if(mm+=1,pm.push(s),Q.root.add(a),a.rotation.y=s.id*.9%(Math.PI*2),i.fly){let e=Om();a.position.copy(e),a.scale.setScalar(.7),of(e,o,.5,{duration:.42,onUpdate:(e,t)=>{a.position.copy(e),a.scale.setScalar(.7+t*.3)},onDone:()=>{a.position.copy(o),a.scale.setScalar(1),s.flying=!1,Kp.register(a,{kind:`item`,itemId:s.id,priority:2}),Jp.ring(o,16761963)}})}else a.position.copy(o),Kp.register(a,{kind:`item`,itemId:s.id,priority:2}),e===`food`&&Jp.steam(o.clone().setY(o.y+.05),5);return s}function jm(e){Kp.unregister(e.node),e.node.removeFromParent();let t=pm.indexOf(e);t>=0&&pm.splice(t,1)}function Mm(e,t,n){Kp.unregister(e.node),e.node.removeFromParent();let r=Tm(t,n),i=Em(e.place,e.slot).clone();r.position.copy(i),r.rotation.y=e.id*.9%(Math.PI*2),Q.root.add(r),Kp.register(r,{kind:`item`,itemId:e.id,priority:2}),e.node=r,e.kind=t,e.recipeId=n,r.scale.setScalar(1.25),nf({duration:.28,onUpdate:e=>r.scale.setScalar(1.25-e*.25),onDone:()=>r.scale.setScalar(1)})}function Nm(e){return pm.find(t=>t.id===e)||null}function Pm(e){return e?e.kind+`:`+(e.recipeId||``)+`:`+(e.id||``)+`:`+ +!!e.chopped:``}function Fm(){let e=Pm(Z.hand);if(e===cm)return;cm=e,sm&&=(am.remove(sm),null);let t=Z.hand;if(!t)return;let n=bp;t.kind===`plate`?sm=Od(!1):t.kind===`dirtyPlate`?sm=Od(!0):t.kind===`ingredient`?(sm=ed(t.id,t.chopped===!0),n=Ep(sm)):sm=jd(t.recipeId);let r=sm;r.userData.handScale=n,r.scale.setScalar(n*.72),r.traverse(e=>{e.isMesh&&(e.castShadow=!1,e.receiveShadow=!1)}),am.add(r),nf({duration:.24,onUpdate:e=>{sm===r&&r.scale.setScalar(n*(.72+.28*e))},onDone:()=>{sm===r&&r.scale.setScalar(n)}})}function Im(){if(hm===Z.plates)return;let e=Z.plates>hm&&hm>=0;if(hm=Z.plates,lm.clear(),Z.plates>0){let t=kd(Z.plates);lm.add(t),e&&(t.scale.setScalar(1.18),nf({duration:.3,onUpdate:e=>t.scale.setScalar(1.18-e*.18),onDone:()=>t.scale.setScalar(1)}))}}function Lm(){let e=Vf()+`|`+Z.daily.join(`,`)+`|`+Z.dailyDone.join(`,`);e!==gm&&(gm=e,Wp.draw(Z.daily,Z.dailyDone,Vf()))}function Rm(e){Q.sinkStation.bubbles.visible=e}function zm(e){if(!e)return`空手`;if(e.kind===`ingredient`){let t=Bu(e.id);return t?t.name:e.id}if(e.kind===`plate`)return`干净盘子`;if(e.kind===`dirtyPlate`)return`脏盘子`;let t=Mu(e.recipeId);return t?t.name:`料理`}function Bm(e){return e.map(e=>Bu(e).name).join(`、`)}function Vm(e){return Xf()?Qf(e)>=0:($.toast(`物品栏满了，先按 Q 把手上的东西放回去`),X.deny(),!1)}function Hm(e,t,n,r=`good`){let i=Ff(e);return t&&n&&Jp.text(t,n,r),i.forEach(e=>Um(e)),i.length>0}function Um(e){let t=Fd(e),n=t.unlock.map(e=>Mu(e));X.levelUp(),$.toast(`升级！Lv.`+e+` · `+t.title),Jp.text(Om().add(new V(0,.25,0)),`Lv.`+e,`level`),wm.showCard({kicker:`LEVEL UP`,title:`Lv.`+e,sub:t.title,items:n.length>0?n.map(e=>({emoji:e.emoji,name:e.name,note:`新菜谱`})):[{emoji:`💪`,name:`继续做菜也能变强`,note:`经验继续累积`}]}),wm.renderGallery()}function Wm(e,t){if(!Gf(e))return;let n=Wf();X.daily(),Hm(n?Nd.daily+Nd.dailyAll:Nd.daily,t,`今日菜单 +`+Nd.daily+` 经验`,`star`),n&&(Hf(),X.sprite(),$.toast(`菜单全清，新一天开始了`),wm.showCard({kicker:`MENU CLEAR`,title:`第 `+Vf()+` 天`,sub:`菜单全部完成，全清奖励 +`+Nd.dailyAll+` 经验，新的菜单已经挂上看板`,items:Z.daily.filter(e=>Mu(e)!==void 0).map(e=>({emoji:Mu(e).emoji,name:Mu(e).name,note:`新菜单`})),duration:3800}))}function Gm(e){if(!e)return``;let t=e.data,n=Z.hand,r=zm(n);if(t.kind===`fridge`)return im?`关上冰箱门`:`打开冰箱门 · 食材都在里面`;if(t.kind===`ingredient`){let e=dm[t.spotIndex];if(!e)return``;if(!im)return`先打开冰箱门`;let n=Bu(e.spot.ingredientId).name;return e.count<=0?`「`+n+`」刚被拿空，马上补货`:Xf()?`拿取「`+n+`」`:`物品栏满了 · 先按 Q 放回手上的东西`}if(t.kind===`chop`){if(!n||n.kind!==`ingredient`)return`切菜板 · 先用数字键选中要切的食材`;if(n.chopped)return`「`+r+`」已经切好了`;if(!Vu(n.id))return`「`+r+`」不用切，直接下锅`;let e=nm.key===Th(n)?nm.steps:0;return`连点切碎「`+r+`」（`+e+`/3）`}if(t.kind===`stove`){if(uh[0].time>=0&&uh[0].recipe||uh[1].time>=0&&uh[1].recipe)return`正在翻炒「`+(uh[0].time>=0?uh[0]:uh[1]).recipe.name+`」…`;let e=fh(0),t=fh(1);if(e||t)return n&&n.kind===`plate`?`把`+(e?`左`:`右`)+`锅里的「`+Mu((e||t).recipeId).name+`」装进盘子`:e&&t?`两个锅都有菜 · 选一个空盘子来装`:(e?`左`:`右`)+`锅里还温着「`+Mu((e||t).recipeId).name+`」· 选一个空盘子来装`;if(n&&n.kind===`ingredient`){if(!n.chopped&&Vu(n.id))return`「`+r+`」要先去切菜板切碎`;if(dh.ids[0].length===0&&dh.ids[1].length===0)return`把「`+r+`」放进锅里`;let e=[];return dh.ids[0].length&&e.push(`左锅有 `+Bm(dh.ids[0])),dh.ids[1].length&&e.push(`右锅有 `+Bm(dh.ids[1])),e.join(` · `)}let i=dh.ids[0].length,a=dh.ids[1].length;if(i+a>0){let e=[];return i&&e.push(`左锅有 `+Bm(dh.ids[0])),a&&e.push(`右锅有 `+Bm(dh.ids[1])),e.join(` · `)+` · 空手点击捞回物品栏`}return n&&n.kind===`dish`?`「`+r+`」已经装好盘了 · 端到餐桌上去`:n&&n.kind===`plate`?`锅是空的 · 先选中切好的食材放进锅里`:n&&n.kind===`dirtyPlate`?`脏盘子得先去水槽洗干净`:`灶台 · 先用数字键选中切好的食材·左右两个灶眼都可以用`}if(t.kind===`plates`)return n?n.kind===`plate`?`把盘子放回盘堆`:`手上拿着「`+r+`」· 换到空格子再拿盘子`:Z.plates>0?`拿一个干净盘子（盘堆剩 `+Z.plates+` 个）`:`盘堆空了，先去水槽洗盘子`;if(t.kind===`sink`)return n&&n.kind===`dirtyPlate`?`把脏盘子洗干净`:n&&n.kind===`plate`?`水槽 · 这个盘子已经是干净的`:`水槽 · 选中脏盘子才能洗`;if(t.kind===`table`)return n&&n.kind===`dish`?`把「`+r+`」端上餐桌`:n?`餐桌 · 手上要端着做好的菜才能上桌`:`餐桌 · 做好菜端过来就能吃`;if(t.kind===`item`){let e=Nm(t.itemId);if(!e)return``;if(e.kind===`food`){let t=performance.now()-e.bornAt<=vp,i=`「`+Mu(e.recipeId).name+`」`;return n&&n.kind===`plate`?`把锅里的`+i+`装进盘子`+(t?`（趁热 +`+Nd.hotPlate+` 经验）`:``):n?n.kind===`dirtyPlate`?`脏盘子不能装菜，先去水槽洗`:`手上拿着`+r+`，换个空盘子来装`:i+`在锅里 · 先选一个空盘子，再到盘堆拿`}return e.kind===`dish`?`吃「`+Mu(e.recipeId).name+`」`:n?`手上拿着「`+r+`」· 换个空格子再来拿`:Xf()?`拿走脏盘子，去水槽洗干净`:`物品栏满了，先按 Q 放回点东西`}return``}function Km(e){let t=dm[e];if(!t||t.count<=0)return;if(!im){$.toast(`冰箱门关着，先打开再拿`),X.deny();return}if(!Xf()){$.toast(`物品栏满了，按 Q 先把手上的东西放回去`),X.deny();return}let n=t.spot.ingredientId,r=!Z.discovered.has(n);Qf({kind:`ingredient`,id:n,chopped:!1}),--t.count,fm(t),t.readyAt=performance.now()+t.refillStep,X.pick(),Jp.spark(t.spot.position.clone().setY(t.spot.position.y+.05),16770736,6),Jp.text(t.spot.position.clone().setY(t.spot.position.y+.16),`+`+Bu(n).name,`good`),r&&$.toast(`新食材入册：`+Bu(n).name)}function qm(){let e=Z.hand;if(!e){$.toast(`手上没有东西`),X.deny();return}if(e.kind===`ingredient`){let t=dm.find(t=>t.spot.ingredientId===e.id&&t.count<t.capacity);$f(Z.selected),t&&(t.count+=1,fm(t)),X.click(),$.toast(`把「`+zm(e)+`」放回了冰箱`);return}if(e.kind===`plate`){$f(Z.selected),rp(),X.plate(),Jp.spark(Q.plateSpot.clone().setY(Q.plateSpot.y+.08),16770736,5),$.toast(`盘子放回了盘堆`);return}if(e.kind===`dirtyPlate`){X.deny(),$.toast(`脏盘子只能拿去水槽洗`);return}X.deny(),$.toast(`做好的菜要端到餐桌上，不能丢`)}function Jm(){im=!im,X.pick(),$.toast(im?`冰箱门开了，食材都在里面`:`冰箱门关上了`)}var Ym=[[-.08,.04,.4],[.02,.09,1.2],[.09,.02,.2],[-.02,-.02,.9],[.07,.11,1.6],[-.06,-.06,2.2]];function Xm(e){$p.bits.clear(),Ym.forEach((t,n)=>{let r=Qu(e,n);r.position.set(.6+t[0],.955,-.04+t[1]),r.rotation.y=t[2],$p.bits.add(r)}),$p.bits.visible=!0,tm.time=0}function Zm(e){if(tm.time<0)return;tm.time+=e;let t=tm.time;if(t<.86){let e=t/.86*Math.PI*4;$p.knife.position.y=em-Math.abs(Math.sin(e))*.032,$p.knife.rotation.z=Math.sin(e)*.1;return}$p.knife.position.y=em,$p.knife.rotation.z=0,t>2.76&&($p.bits.visible=!1,tm.time=-1)}function Qm(){let e=em;nf({duration:.28,onUpdate:(t,n)=>{$p.knife.position.y=e-Math.sin(n*Math.PI)*.05,$p.knife.rotation.z=Math.sin(n*Math.PI)*.06},onDone:()=>{$p.knife.position.y=e,$p.knife.rotation.z=0}})}function $m(e){let t=im?Qp.openAngle:0,n=Qp.pivot.rotation.y;if(Math.abs(t-n)<.002){n!==t&&(Qp.pivot.rotation.y=t,Qp.updateArea(),qp.resolve());return}let r=Math.min(mp*e,Math.abs(t-n));Qp.pivot.rotation.y=n+Math.sign(t-n)*r,Qp.updateArea(),qp.resolve()}var eh=2.1,th=[[-.05,-.035],[.045,.02],[.005,.055],[.055,-.04],[-.045,.045]],nh=Q.cookStation.panLeft,rh=Q.cookStation.panRight,ih=nh.userData.body,ah=rh.userData.body,oh=nh.position.clone(),sh=rh.position.clone(),ch=Q.cookStation.foodSpotLeft.clone(),lh=Q.cookStation.foodSpotRight.clone(),uh=[{time:-1,flame:0,jolt:0,steam:0,tossed:!1,recipe:null,activeBurner:0},{time:-1,flame:0,jolt:0,steam:0,tossed:!1,recipe:null,activeBurner:1}],dh={ids:[[],[]],models:[[],[]],burner:0};function fh(e){return pm.find(t=>t.place===`pan`&&t.slot===e)||null}function ph(e){let t=e===0?ch:lh;return t.clone().setY(t.y+.07)}function mh(e,t){let n=th[e%th.length];return(t===0?ch:lh).clone().add(new V(n[0],.004,n[1]))}function hh(e){let t=dh.ids[e]||[],n=dh.models[e]||[];n.forEach(e=>e.removeFromParent()),n.length=0,t.length=0}function gh(e,t){let n=ed(e,!0);n.scale.setScalar(wp);let r=Om();n.position.copy(r),Q.root.add(n);let i=dh.ids[t]=dh.ids[t]||[],a=dh.models[t]=dh.models[t]||[];i.push(e),a.push(n);let o=mh(i.length-1,t);of(r,o,.44,{duration:.38,onUpdate:e=>n.position.copy(e),onDone:()=>{n.position.copy(o),n.scale.setScalar(Tp),uh[t].jolt=1,X.drop(),Jp.spark(o,Bu(e).color,5),Jp.steam(o,2),_h(t)}})}function _h(e){let t=dh.ids[e]||[];if(t.length===0)return;let n=Sf(t.map(e=>({id:e,chopped:!0})));if(!n.ok){n.reason===`nomatch`&&$.toast(yh(e)+`里现在是 `+Bm(t)+`，再加点别的试试`);return}if(!Nf(n.recipe.id)){$.toast(`「`+n.recipe.name+`」要 Lv.`+Bd(n.recipe.id)+` 才解锁，空手点灶台可以捞回来`),X.deny();return}bh(n.recipe,e)}function vh(e){let t=dh.ids[e]||[];if(t.length===0)return!1;if(Zf()+t.length>6)return $.toast(`物品栏放不下锅里的食材，先按 Q 放回一些东西`),X.deny(),!1;let n=t.slice();return hh(e),n.forEach(e=>Qf({kind:`ingredient`,id:e,chopped:!0})),X.pick(),$.toast(`把`+yh(e)+`里的 `+Bm(n)+` 捞回了物品栏`),!0}function yh(e){return e===0?`左锅`:`右锅`}function bh(e,t){let n=uh[t];n.time=0,n.jolt=0,n.steam=0,n.tossed=!1,n.recipe=e,n.activeBurner=t,X.sizzle(),Jp.ring(ph(t),16754263),$.startAction({label:`开火下锅 · `+e.name,duration:eh,onDone:()=>xh(t)})}function xh(e){let t=uh[e],n=t.recipe;t.time=-1,t.recipe=null;let r=e===0?ih:ah,i=e===0?nh:rh,a=e===0?oh:sh;if(r.rotation.set(0,0,0),i.position.copy(a),hh(e),!n)return;let o=Am(`food`,n.id,`pan`,e,{hot:!0}),s=!Z.cooked.has(n.id);ip(n.id),If(n.id,1),X.cook(),Jp.spark(ph(e),16767392,7),Jp.steam(ph(e),4);let c=km(o);$.toast(`出锅：`+n.name+`，就在`+yh(e)+`里，拿个空盘子来装`),Wm(n.id,c);let l=Nd.cook+(s?Nd.firstTime:0);Hm(l,c,(s?`首次出炉 `:``)+`+`+l+` 经验`)}function Sh(e){return e===0?Q.cookStation.flameLeft:Q.cookStation.flameRight}function Ch(e){return e===0?Q.cookStation.flameLightLeft:Q.cookStation.flameLightRight}function wh(e){for(let t=0;t<2;t+=1){let n=uh[t],r=n.time>=0;r&&(n.time=Math.min(n.time+e,eh));let i=fh(t);n.flame+=((r?1:i?.3:0)-n.flame)*Math.min(e*7,1);let a=Sh(t);if(a.visible=n.flame>.03,a.visible){let e=1+Math.sin(performance.now()*.012+t*3.7)*.14,r=.35+.65*n.flame;a.scale.set(e*r,Math.max(n.flame*e,.06),e*r)}let o=Ch(t);if(o.intensity=n.flame*1.6*(1+Math.sin(performance.now()*.021+t*4.2)*.14),!r){let r=t===0?ih:ah,i=t===0?nh:rh,a=t===0?oh:sh;n.jolt=Math.max(0,n.jolt-e*3.4),n.jolt<=0&&(r.rotation.set(0,0,0),i.position.copy(a));continue}let s=t===0?ih:ah,c=t===0?nh:rh,l=t===0?oh:sh,u=n.time,d=Math.min(1,u/.22)*Math.min(1,(eh-u)/.4),f=Math.sin(u*27)*.05*d+n.jolt*.075,p=Math.sin(u*33)*.008*d,m=0;u>1.25&&u<1.85&&(m=Math.sin((u-1.25)/.6*Math.PI)*.5),s.rotation.z=f,s.rotation.x=m,c.position.set(l.x,l.y+p+m*.035,l.z),n.steam+=e,n.steam>.2&&(n.steam=0,Jp.steam(ph(t),2)),!n.tossed&&u>1.52&&(n.tossed=!0,X.toss(),Jp.crumbs(ph(t),16761963),Jp.spark(ph(t),16756838,6),Jp.steam(ph(t),3),(dh.models[t]||[]).forEach((e,t)=>{let n=e.position.clone();nf({duration:.5,delay:t*.05,onUpdate:t=>{e.position.copy(n),e.position.y=n.y+Math.sin(t*Math.PI)*.2,e.rotation.x=t*1.4},onDone:()=>{e.position.copy(n),e.rotation.x=0}})}))}}function Th(e){return Z.selected+`:`+e.id}function Eh(){let e=Z.hand;if(!e||e.kind!==`ingredient`){$.toast(`先用数字键选中要切的食材`),X.deny();return}if(e.chopped){$.toast(`「`+zm(e)+`」已经切好了`),X.deny();return}if(!Vu(e.id)){$.toast(`「`+zm(e)+`」不用切，直接下锅就行`),X.deny();return}let t=Th(e);nm.key!==t&&(nm.key=t,nm.steps=0),nm.steps+=1;let n=new V(.6,.95,0),r=new W(Bu(e.id).color).getHex();if(om.punch=1,nm.steps<hp){Qm(),X.chop(nm.steps),Jp.crumbs(n,r);return}ep(Z.selected),X.chopped(),Jp.crumbs(n,r),Jp.text(n.clone().setY(n.y+.18),`切碎了「`+zm(e)+`」`,`good`),nm.key=null,nm.steps=0,Xm(e.id),$.toast(`「`+zm(e)+`」切好了，可以下锅了`)}function Dh(e){e??=0;let t=fh(e);if(t){if(Z.hand&&Z.hand.kind===`plate`)return;$.toast((e===0?`左`:`右`)+`锅里还温着「`+Mu(t.recipeId).name+`」，选一个空盘子来装`),X.deny();return}if(uh[e].time>=0)return;let n=Z.hand;if(n&&n.kind===`ingredient`){if(!n.chopped&&Vu(n.id)){$.toast(`「`+zm(n)+`」要先去切菜板切碎`),X.deny();return}$f(Z.selected),X.pick(),$.toast(`下锅：`+zm(n)),gh(n.id,e);return}(dh.ids[e]||[]).length>0&&vh(e)||(X.deny(),$.toast(n?`手上要拿着切好的食材才能下锅`:`先用数字键选中切好的食材`))}function Oh(){let e=Z.hand;if(!e){if(!np()){$.toast(`盘堆空了，先把脏盘子洗干净`),X.deny();return}tp({kind:`plate`}),X.plate(),Jp.ring(Q.plateSpot.clone().setY(Q.plateSpot.y+.06),16767392);return}if(e.kind===`plate`){rp(),tp(null),X.plate(),Jp.spark(Q.plateSpot.clone().setY(Q.plateSpot.y+.08),16770736,5),$.toast(`盘子放回了盘堆`);return}$.toast(e.kind===`dirtyPlate`?`脏盘子得先洗干净才能放回盘堆`:`手上还端着菜`),X.deny()}function kh(){let e=Z.hand;if(!e||e.kind!==`dirtyPlate`){$.toast(e&&e.kind===`plate`?`这个盘子已经是干净的了`:`把脏盘子拿过来才能洗`),X.deny();return}let t=Q.sinkSpot.clone().setY(1);Rm(!0),X.wash(),$.startAction({label:`冲一冲、刷一刷`,duration:_p,onDone:()=>{Rm(!1),tp({kind:`plate`}),Kf(),X.washDone(),Jp.spark(t,12575999,9),Jp.ring(t,12575999),Hm(Nd.wash,t,`洗干净 +`+Nd.wash+` 经验`),$.toast(`盘子洗好了，可以再次装菜`)}})}function Ah(){let e=Z.hand;if(!e||e.kind!==`dish`){$.toast(e&&e.kind===`plate`?`盘子还空着，先去装一份菜`:`端着做好的菜才能上桌`),e&&X.deny();return}let t=Dm(`table`);if(t<0){$.toast(`餐桌摆满了，先吃掉一份`),X.deny();return}let n=Mu(e.recipeId).name,r=!!Z.hand.hot;tp(null);let i=Am(`dish`,e.recipeId,`table`,t,{fly:!0,hot:r});if(i.hot=r,qf(),r){let t=Rf(),n=Nd.hotPlate+Math.min(t,5)*2;Hm(n,km(i),`趁热上桌 +`+n+` 经验`,`star`),If(e.recipeId,2),t>=2&&Jp.text(km(i).add(new V(0,.22,0)),`连击 x`+t,`star`)}else zf(),$.toast(`这盘有点凉了，下次出锅就趁热带过来吧`);$.toast(`上菜：`+n+`，再点一下就能吃`),X.serve()}function jh(e){let t=Mu(e.recipeId),n=km(e);X.eat(),Jp.text(n,`开始品尝…`),$.startAction({label:`品尝「`+t.name+`」`,duration:gp,onDone:()=>{ap(e.recipeId);let t=e.hot?3:2;If(e.recipeId,t),X.eatDone(),Jp.spark(n,16769192,10),Jp.text(n.clone().setY(n.y+.1),`★`.repeat(t)+` 吃得很满足`,`star`),Hm(Nd.eat,n,`+`+Nd.eat+` 经验`),Mm(e,`dirty`,null),$.toast(`盘子变脏了，拿去水槽洗一洗`)}})}function Mh(e){let t=Nm(e);if(!t||t.flying)return;let n=Z.hand;if(t.kind===`food`){if(n&&n.kind===`plate`){let e=t.recipeId,n=performance.now()-t.bornAt<=vp,r=t.node.position.clone(),i=Tm(`dish`,e),a=pm.indexOf(t);a>=0&&pm.splice(a,1),Kp.unregister(t.node),t.node.removeFromParent(),i.position.copy(r),Q.root.add(i),of(r,Om(),.35,{duration:.3,onUpdate:(e,t)=>{i.position.copy(e),i.scale.setScalar(Math.max(.25,1-t*.7))},onDone:()=>i.removeFromParent()}),tp({kind:`dish`,recipeId:e,hot:n}),X.plate(),Jp.spark(r,16773320,6),$.toast(`装盘：`+Mu(e).name+(n?` · 趁热`:``));return}if(n&&n.kind===`dish`){$.toast(`手上已经端着「`+zm(n)+`」了`),X.deny();return}if(n&&n.kind===`dirtyPlate`){$.toast(`脏盘子不能装菜，先去水槽洗`),X.deny();return}$.toast(`先换到一个空格子，到盘堆拿个空盘子，再回来装`+(t.place===`pan`?`锅里的`:``)+`菜`),X.deny();return}if(t.kind===`dirty`){if(!Vm({kind:`dirtyPlate`}))return;jm(t),X.pick(),$.toast(`拿起脏盘子，去水槽洗一洗`);return}jh(t)}function Nh(e){if(e.kind===`ingredient`){Km(e.spotIndex);return}if(e.kind===`fridge`){Jm();return}if(e.kind===`chop`){Eh();return}if(e.kind===`stove`){Dh(e.burner);return}if(e.kind===`plates`){Oh();return}if(e.kind===`sink`){kh();return}if(e.kind===`table`){Ah();return}e.kind===`item`&&Mh(e.itemId)}function Ph(e){dm.forEach(t=>{t.count>=t.capacity||e<t.readyAt||(t.count+=1,fm(t),t.readyAt=e+t.refillStep)})}Kp.register(Q.cookStation.hitboxLeft,{kind:`stove`,burner:0,priority:1}),Kp.register(Q.cookStation.hitboxRight,{kind:`stove`,burner:1,priority:1}),Kp.register(Qp.hitbox,{kind:`fridge`,priority:2}),Kp.register($p.hitbox,{kind:`chop`,priority:2}),Kp.register(Q.sinkStation.hitbox,{kind:`sink`,priority:2}),Kp.register(Up.hitbox,{kind:`table`,priority:1}),Kp.register(um,{kind:`plates`,priority:2});var Fh=document.getElementById(`btn-sound`);Fh.textContent=hf()?`🔇`:`🔊`,Fh.addEventListener(`click`,()=>{pf(),Fh.textContent=mf()?`🔇`:`🔊`}),qp.onLockChange(e=>{e&&(bm=!0),xm()}),qp.onTap(()=>{if(pf(),wm.cardOpen()){wm.closeCard();return}if($.busy()||wm.isBlocking()||!ym)return;if(!vm&&bm&&!qp.isLocked()){qp.requestLock(),xm();return}let e=Kp.getHovered();e&&(om.punch=Math.max(om.punch,.7),Nh(e.data))});var Ih=[`Digit1`,`Digit2`,`Digit3`,`Digit4`,`Digit5`,`Digit6`];window.addEventListener(`keydown`,e=>{if(e.repeat||!ym)return;let t=Ih.indexOf(e.code);if(t>=0&&t<6&&!wm.isBlocking()){Yf(t)&&X.click();return}if(!wm.isBlocking()){if(e.code===`KeyQ`){qm();return}if(e.code===`KeyE`){Sm();return}e.code===`KeyM`&&Cm()}}),Df(()=>{$.updateTray(Z.tray,Z.selected),$.updateHand(Z.hand),$.refreshStats(),$.updateProgress(Pf()),$.updateDaily(Z.daily,Z.dailyDone,Z.streak,Vf()),Fm(),Im(),Lm(),wm.galleryOpen()&&wm.renderGallery()}),window.addEventListener(`resize`,()=>{Hp.aspect=window.innerWidth/window.innerHeight,Hp.updateProjectionMatrix(),Ap.setSize(window.innerWidth,window.innerHeight)});var Lh=performance.now(),Rh=0,zh=0,Bh=new V,Vh=0,Hh=!1;function Uh(e){if(!e)return;Vh+=e;let t=qp.isCrouched()?1.05:.72;Vh<t||(Vh=0,Hh=!Hh,X.step(qp.isCrouched(),Hh))}function Wh(e){let t=Bh.distanceTo(Hp.position);Bh.copy(Hp.position);let n=Math.min(t/Math.max(e*2.2,1e-4),1);zh+=(n-zh)*Math.min(e*7,1),om.punch=Math.max(0,om.punch-e*4.2),Rh+=e,am.position.set(yp.x+Math.sin(Rh*4.4)*.012*zh,yp.y+Math.sin(Rh*8.8)*.016*zh-om.punch*.028,yp.z-om.punch*.05),am.rotation.z=Math.sin(Rh*4.4)*.05*zh,sm&&sm.scale.setScalar((sm.userData.handScale||bp)*(1+om.punch*.07))}var Gh=0,Kh=0,qh=!1,Jh=!0,Yh=-1;function Xh(){let e=pm.length*7+(dh.models[0].length+dh.models[1].length)*131+Z.plates*3;for(let t=0;t<dm.length;t+=1)e+=(dm[t].count+1)*(t*7+3);return Q.sinkStation.bubbles.visible&&(e+=512),e}function Zh(){if(!qh){qh=!0;try{Qh()}catch{qh=!0}}}function Qh(){window.setTimeout(pf,260);let e=[];Gp.traverse(t=>{t.visible||=(e.push(t),!0)}),Ap.compile(Gp,Hp);let t=Hp.position.clone();Jp.crumbs(t,16777215),Jp.steam(t,2),Jp.spark(t),Jp.ring(t),Ap.render(Gp,Hp),Ap.render(Gp,Hp),Jp.clear(),e.forEach(e=>{e.visible=!1}),Ap.render(Gp,Hp)}function $h(e){window.requestAnimationFrame($h);let t=(e-Lh)/1e3;if(Lh=e,document.hidden)return;let n=t>.25,r=Math.min(t,.1);Gh=Math.max(Gh,t),Kh+=1,rf(r),Jp.update(r),$m(r),Zm(r),wh(r),$.tickAction(r),wm.isBlocking()?$.setHint(``,!1):(Uh(qp.update(r)),Ph(e),$.setHint(Gm(Kp.detect()),!0)),Wh(r);let i=Xh();i!==Yh&&(Yh=i,Jh=!0);let a=Math.abs(Qp.pivot.rotation.y-(im?Qp.openAngle:0))>6e-4,o=af()>0||tm.time>=0||uh[0].time>=0||uh[1].time>=0;(Jh||a||o&&e-zp>=jp)&&(Ap.shadowMap.needsUpdate=!0,zp=e),Jh=!1,n?(Pp=Fp,Ip=0,Lp=Math.max(Lp,30)):Vp(t),Ap.render(Gp,Hp)}cp(),Bf(),$.updateTray(Z.tray),$.updateHand(Z.hand),$.refreshStats(),$.updateProgress(Pf()),$.updateDaily(Z.daily,Z.dailyDone,Z.streak,Vf()),Fm(),Im(),Lm(),qp.setObstacles(Q.obstacles.concat(Up.obstacles,[Qp.area])),qp.setView(Q.spawn.position,Q.spawn.yaw),Bh.copy(Hp.position),wm.openMenu(),window.setTimeout(Zh,400),window.requestAnimationFrame($h),window.__bootOk=!0;